...
## [1.62.0](https://github.com/MoeLa/seatsurfing/compare/v1.61.0...v1.62.0) (2026-02-26)


### Features

* add ability to change org name and contact details in Admin UI ([#1140](https://github.com/MoeLa/seatsurfing/issues/1140)) ([b054dc5](https://github.com/MoeLa/seatsurfing/commit/b054dc5082d18eb03163b6455d84b98bfb333dd7))
* add ability to disable password login ([#1352](https://github.com/MoeLa/seatsurfing/issues/1352)) ([2c38823](https://github.com/MoeLa/seatsurfing/commit/2c38823e30ef24d25ff26ea8e990e2eca158f166))
* add ability to scale floor plans ([#1594](https://github.com/MoeLa/seatsurfing/issues/1594)) ([e49a0d6](https://github.com/MoeLa/seatsurfing/commit/e49a0d67a209344c660097b01269103411d2b636))
* add admin-option to reset MFA for a user ([#1736](https://github.com/MoeLa/seatsurfing/issues/1736)) ([76c91c5](https://github.com/MoeLa/seatsurfing/commit/76c91c5cf93e62f7d0e97618db1894eff941cba0))
* add calender view to "my bookings" ([#1583](https://github.com/MoeLa/seatsurfing/issues/1583)) ([2544ae5](https://github.com/MoeLa/seatsurfing/commit/2544ae54220b0a7a0746fa6a7b9d376f512b5a4d))
* add confirmation mail for org deletion ([#1587](https://github.com/MoeLa/seatsurfing/issues/1587)) ([9fcaab9](https://github.com/MoeLa/seatsurfing/commit/9fcaab98db416f04077c8d9f7c3581d19c42e34c))
* add created timestamp to bookings ([#1373](https://github.com/MoeLa/seatsurfing/issues/1373)) ([5a1c4f6](https://github.com/MoeLa/seatsurfing/commit/5a1c4f6b4374a3ff0159350d1979f3202f0b8e50))
* add current filter to admin booking UI ([#1589](https://github.com/MoeLa/seatsurfing/issues/1589)) ([5b1bcc4](https://github.com/MoeLa/seatsurfing/commit/5b1bcc4f159a3e689b4071e0bff8e7f683d07fd7))
* add dedicated localizations for en-GB and en-US ([#1413](https://github.com/MoeLa/seatsurfing/issues/1413)) ([49e36e8](https://github.com/MoeLa/seatsurfing/commit/49e36e86b85e8600d2a12f803c7cc6e2c875ff29))
* add filter "Today" in admin booking UI ([#1664](https://github.com/MoeLa/seatsurfing/issues/1664)) ([29e7bcc](https://github.com/MoeLa/seatsurfing/commit/29e7bcc029f5ff3523aa6b28c14c655b4895b6bb))
* add icon to language selectors ([#1351](https://github.com/MoeLa/seatsurfing/issues/1351)) ([46ff1cb](https://github.com/MoeLa/seatsurfing/commit/46ff1cbab188bfa1bfe728ca1e651e3d91028fff))
* add mail log ([#1571](https://github.com/MoeLa/seatsurfing/issues/1571)) ([a32bf23](https://github.com/MoeLa/seatsurfing/commit/a32bf23de2c18c85a0d8222b9ed0ad9191395d41))
* add mail notifications if a booking was approved, updated or deleted ([#1282](https://github.com/MoeLa/seatsurfing/issues/1282)) ([e2220e0](https://github.com/MoeLa/seatsurfing/commit/e2220e0c8d0c6e392d403f704cdddf630f60b22a))
* add more information to existing booking popup ([#1492](https://github.com/MoeLa/seatsurfing/issues/1492)) ([98cbe1a](https://github.com/MoeLa/seatsurfing/commit/98cbe1a6508a8a9f787a10aa47f5a2cce692ac9a))
* add my booking info to existing booking popup ([#1504](https://github.com/MoeLa/seatsurfing/issues/1504)) ([fa2edd1](https://github.com/MoeLa/seatsurfing/commit/fa2edd15d4175a2c1a8b2a72443935560e63361d))
* add name, description and timezone to location info modal ([#1411](https://github.com/MoeLa/seatsurfing/issues/1411)) ([9465e45](https://github.com/MoeLa/seatsurfing/commit/9465e452f14f9e0ccb591eb1ad295c108bd282b4))
* add number of records and user's firstname and lastname in user admin UI ([#1443](https://github.com/MoeLa/seatsurfing/issues/1443)) ([3af1dab](https://github.com/MoeLa/seatsurfing/commit/3af1dab50bbc58c8f51dff0a3ca29bb0e5c8d51e))
* add optional info to subject placeholder ([#1281](https://github.com/MoeLa/seatsurfing/issues/1281)) ([85d9ab5](https://github.com/MoeLa/seatsurfing/commit/85d9ab555a8e698a264dc3796fc4e5ed20793512))
* add optional organization address ([#1603](https://github.com/MoeLa/seatsurfing/issues/1603)) ([8a5d1ca](https://github.com/MoeLa/seatsurfing/commit/8a5d1caa8a1cc522c351bf3d3fa9a31f160d5453))
* add org setting for user's default mail notification setting ([#1673](https://github.com/MoeLa/seatsurfing/issues/1673)) ([76a4c49](https://github.com/MoeLa/seatsurfing/commit/76a4c49fbfc18763e88d75560da8fe4021f90f10))
* add retention settings for bookings ([#1509](https://github.com/MoeLa/seatsurfing/issues/1509)) ([20b9194](https://github.com/MoeLa/seatsurfing/commit/20b9194df9eb2251420afb1c647055436f65aeb3))
* add setting to enable/disable recurring bookings ([#1570](https://github.com/MoeLa/seatsurfing/issues/1570)) ([698e345](https://github.com/MoeLa/seatsurfing/commit/698e345be2eba90c53976201c7ce3235f66cadf3))
* add subject to email booking notification ([#1270](https://github.com/MoeLa/seatsurfing/issues/1270)) ([9dd7bd5](https://github.com/MoeLa/seatsurfing/commit/9dd7bd56309efe12bd8fdebe5d45c8b09474a39d))
* add support for Passkeys / WebAuthn ([#1731](https://github.com/MoeLa/seatsurfing/issues/1731)) ([34f0265](https://github.com/MoeLa/seatsurfing/commit/34f0265d8fb88518cfa16b2257da95c7fc88162e))
* add TOTP support ([#1717](https://github.com/MoeLa/seatsurfing/issues/1717)) ([ed686a1](https://github.com/MoeLa/seatsurfing/commit/ed686a1ca62959d1df27ffd004393d501bf1abbf))
* add user and organization plugin hooks ([#1355](https://github.com/MoeLa/seatsurfing/issues/1355)) ([bf1251f](https://github.com/MoeLa/seatsurfing/commit/bf1251fd07e7d11eec4cc2fa6cc07bd868d6e3ad))
* add user filter to admin booking UI ([#1665](https://github.com/MoeLa/seatsurfing/issues/1665)) ([959e195](https://github.com/MoeLa/seatsurfing/commit/959e19536e2bed6ef80b9665da5285ee906085dc))
* allow auto-login with DISABLE_PASSWORD_LOGIN enabled ([#1354](https://github.com/MoeLa/seatsurfing/issues/1354)) ([2579c40](https://github.com/MoeLa/seatsurfing/commit/2579c40f903f68385c6de51ec2e307f867fce3e4))
* allow language selection when logged in ([#1344](https://github.com/MoeLa/seatsurfing/issues/1344)) ([d8f0e6e](https://github.com/MoeLa/seatsurfing/commit/d8f0e6ee00049cd9b81caae1a28ef6a5c503b4f3))
* allow read-only IdPs and profile page URLs ([#1345](https://github.com/MoeLa/seatsurfing/issues/1345)) ([8f74526](https://github.com/MoeLa/seatsurfing/commit/8f745269c329c60909e18060ea8242aa4dd88e84))
* allow specification of first- and lastnames for users ([#1369](https://github.com/MoeLa/seatsurfing/issues/1369)) ([f35bd54](https://github.com/MoeLa/seatsurfing/commit/f35bd54c260d9671ce0a1a210ed9e50ce6ae5032))
* booking cards on admin dashboard link to filtered bookings view ([#1287](https://github.com/MoeLa/seatsurfing/issues/1287)) ([479984d](https://github.com/MoeLa/seatsurfing/commit/479984dcdcea21c37874800d1fd2347b183456e0))
* calDAV integration and iCal attachments for recurring bookings ([#1508](https://github.com/MoeLa/seatsurfing/issues/1508)) ([7dbb55f](https://github.com/MoeLa/seatsurfing/commit/7dbb55fdfa153b47323e20c2890540b97a6ce671))
* configurable subject behaviour ([#1567](https://github.com/MoeLa/seatsurfing/issues/1567)) ([6d0da2f](https://github.com/MoeLa/seatsurfing/commit/6d0da2ffb00dfdcfb754016afa3161472290c5a3))
* feedback button in admin ui (cloud-hosted only) ([#1092](https://github.com/MoeLa/seatsurfing/issues/1092)) ([cf81173](https://github.com/MoeLa/seatsurfing/commit/cf81173c6351898aa4251ec781922b3986495c23))
* improve visibility of search bar in admin UI ([#1318](https://github.com/MoeLa/seatsurfing/issues/1318)) ([0f04875](https://github.com/MoeLa/seatsurfing/commit/0f04875dd6c898c67e71c177c2bcc1d892511d39))
* improved date/time picker based on Flatpickr ([#1582](https://github.com/MoeLa/seatsurfing/issues/1582)) ([3ef3722](https://github.com/MoeLa/seatsurfing/commit/3ef3722694d52e5a883658b6179f558dabc87d9a))
* improved user onboarding ([#1718](https://github.com/MoeLa/seatsurfing/issues/1718)) ([2368371](https://github.com/MoeLa/seatsurfing/commit/2368371ff1c64fa2025dcad6a32ff2e43fe53dbc))
* introduce session id to improve security ([#1703](https://github.com/MoeLa/seatsurfing/issues/1703)) ([02035bb](https://github.com/MoeLa/seatsurfing/commit/02035bb4f53c80ad5bdff40d87d1c1b371d12747))
* make booking links clickable in admin UI ([#1510](https://github.com/MoeLa/seatsurfing/issues/1510)) ([2772d0d](https://github.com/MoeLa/seatsurfing/commit/2772d0d111839d1d4e3bc562bd853753c9f45765))
* merge admin and booking ui ([#1324](https://github.com/MoeLa/seatsurfing/issues/1324)) ([4f6cf36](https://github.com/MoeLa/seatsurfing/commit/4f6cf3693708bd455a9353cf9e5366a43496b5c4))
* optional booking approver notifications ([#1573](https://github.com/MoeLa/seatsurfing/issues/1573)) ([e1a8f59](https://github.com/MoeLa/seatsurfing/commit/e1a8f591ab704f3df1f64b78752a50f6de66d702))
* organizations get soft-deleted when deleted via Admin UI ([#1432](https://github.com/MoeLa/seatsurfing/issues/1432)) ([602838e](https://github.com/MoeLa/seatsurfing/commit/602838e90bc1fcb404e767029959a7dd3183419b))
* per-user rate limits ([#1602](https://github.com/MoeLa/seatsurfing/issues/1602)) ([f16421a](https://github.com/MoeLa/seatsurfing/commit/f16421a2c6a9e4ffb4feb01753f600417737e731))
* record timestamp of latest (login) activity for users ([#1375](https://github.com/MoeLa/seatsurfing/issues/1375)) ([42bfd92](https://github.com/MoeLa/seatsurfing/commit/42bfd9240f4ee80596a4767821193aba18793ae9))
* refactored credentials handling and persistence in frontends ([#1174](https://github.com/MoeLa/seatsurfing/issues/1174)) ([f80b630](https://github.com/MoeLa/seatsurfing/commit/f80b630f2a3dd713775d9ea6f812e177594d7a02))
* remove deprecated legacy global login ([#1353](https://github.com/MoeLa/seatsurfing/issues/1353)) ([cb15c62](https://github.com/MoeLa/seatsurfing/commit/cb15c624655144a90b5c0f654e3a2952d7953498))
* replace last week by current booking stats in admin dashboard ([#1670](https://github.com/MoeLa/seatsurfing/issues/1670)) ([e5b7b96](https://github.com/MoeLa/seatsurfing/commit/e5b7b968cc2f8612c05fd69f90befe2ce68f04aa))
* set first name and last name from Auth Provider / IdP ([#1452](https://github.com/MoeLa/seatsurfing/issues/1452)) ([52af1bb](https://github.com/MoeLa/seatsurfing/commit/52af1bb538e051a5e298472637f03f4b408b8a71))
* show default time zone on area admin page ([#1316](https://github.com/MoeLa/seatsurfing/issues/1316)) ([0aaadab](https://github.com/MoeLa/seatsurfing/commit/0aaadabc21f3ec6991adaac953028c2435fc97dd))
* show sidebar in admin interface on mobile viewport ([#1320](https://github.com/MoeLa/seatsurfing/issues/1320)) ([f8de296](https://github.com/MoeLa/seatsurfing/commit/f8de296dc3c7823103f7ba48cb5eda5abf5eee94))
* support SVG floor plans ([#1593](https://github.com/MoeLa/seatsurfing/issues/1593)) ([01ebf46](https://github.com/MoeLa/seatsurfing/commit/01ebf462c671a54aabe5e3cf01af5902ec8f02ba))
* use custom DNS resolver in domain accessibility verification http client ([#1125](https://github.com/MoeLa/seatsurfing/issues/1125)) ([c76fa86](https://github.com/MoeLa/seatsurfing/commit/c76fa86d8080ddd96129a0d43792dabc21f8b04c))
* use date picker in admin analysis UI ([#1444](https://github.com/MoeLa/seatsurfing/issues/1444)) ([b33fe88](https://github.com/MoeLa/seatsurfing/commit/b33fe88be6803f7ce4f194b1029bc0b220fae144))
* use date time picker in admin booking UI ([#1434](https://github.com/MoeLa/seatsurfing/issues/1434)) ([4b35dec](https://github.com/MoeLa/seatsurfing/commit/4b35dec73aa2c619284ce999544b62c16efef486))


### Bug Fixes

* (all) booking link on admin dashboard should show all bookings ([#1424](https://github.com/MoeLa/seatsurfing/issues/1424)) ([4c9ed35](https://github.com/MoeLa/seatsurfing/commit/4c9ed352849b019ca0e873b27e77d757f44d37fe))
* add admin navbar logo on mobile viewport again ([#1335](https://github.com/MoeLa/seatsurfing/issues/1335)) ([1c6662c](https://github.com/MoeLa/seatsurfing/commit/1c6662c6587788eb75502c137a21932c660a3f78))
* add browser console logging if localStorage access fails ([#1726](https://github.com/MoeLa/seatsurfing/issues/1726)) ([c237587](https://github.com/MoeLa/seatsurfing/commit/c237587d88cf5fcd362388b9d6a8baaaf8cbdb02))
* add error code if booking is in the past ([#1566](https://github.com/MoeLa/seatsurfing/issues/1566)) ([a6ccdf2](https://github.com/MoeLa/seatsurfing/commit/a6ccdf2ed34e60f087610db01c78fbf0bae50fa4))
* add error logging when generating access token failed ([#1278](https://github.com/MoeLa/seatsurfing/issues/1278)) ([9ab4241](https://github.com/MoeLa/seatsurfing/commit/9ab4241bf8925880c5f245405cbf8de62fa3bcae))
* add method for selecting orgs by signup date ([#1158](https://github.com/MoeLa/seatsurfing/issues/1158)) ([c5d59cb](https://github.com/MoeLa/seatsurfing/commit/c5d59cbc508569da09409fc60ba15d862de578d5))
* add missing entities to org delete ([#1372](https://github.com/MoeLa/seatsurfing/issues/1372)) ([26a124e](https://github.com/MoeLa/seatsurfing/commit/26a124e2486b6625426ae7ccc4ce41a9a92607b7))
* add missing error logging in organization router ([#1258](https://github.com/MoeLa/seatsurfing/issues/1258)) ([327242c](https://github.com/MoeLa/seatsurfing/commit/327242c9c88de114b0870e9a710687d1cdf7dc36))
* add missing German translations ([#1245](https://github.com/MoeLa/seatsurfing/issues/1245)) ([64fe53d](https://github.com/MoeLa/seatsurfing/commit/64fe53ddaad23fbb8c6d5dfda565631c82ba5beb))
* add missing OnOrganizationCreated hook ([#1364](https://github.com/MoeLa/seatsurfing/issues/1364)) ([8359293](https://github.com/MoeLa/seatsurfing/commit/8359293675b5984bcb839539f7418d9531caf741))
* add missing translation for edit space modal ([#1559](https://github.com/MoeLa/seatsurfing/issues/1559)) ([a3cbdb7](https://github.com/MoeLa/seatsurfing/commit/a3cbdb71760bdc60993410483c090b3c38b50e5d))
* add number of bookings info ([#1425](https://github.com/MoeLa/seatsurfing/issues/1425)) ([38d3fc1](https://github.com/MoeLa/seatsurfing/commit/38d3fc1eb2c1436f1d4c7a9cf6da0ac158585d7f))
* add param length validation to sendmail ([#1677](https://github.com/MoeLa/seatsurfing/issues/1677)) ([a573f5a](https://github.com/MoeLa/seatsurfing/commit/a573f5a6ab655aa551ddb53abdb6bfec068f9f72))
* add payload validations ([#1678](https://github.com/MoeLa/seatsurfing/issues/1678)) ([665a3eb](https://github.com/MoeLa/seatsurfing/commit/665a3ebcae421111c570a7916561480ba60e391a))
* add Portuguese translations ([#1192](https://github.com/MoeLa/seatsurfing/issues/1192)) ([001d797](https://github.com/MoeLa/seatsurfing/commit/001d7972e6ea27b76c4f8c0d961bad2085ae4655))
* add reason and error details to login failed URL ([#1259](https://github.com/MoeLa/seatsurfing/issues/1259)) ([8608f73](https://github.com/MoeLa/seatsurfing/commit/8608f7349a195eaa7a7dc7bfc1f59db14aa2bacb))
* add rel="noopener noreferrer" to all target="_blank" links ([#1725](https://github.com/MoeLa/seatsurfing/issues/1725)) ([476c45e](https://github.com/MoeLa/seatsurfing/commit/476c45e72501c28647cd8e3501a9c299f09e1d8b))
* add some security related HTTP headers ([#1680](https://github.com/MoeLa/seatsurfing/issues/1680)) ([2046d4a](https://github.com/MoeLa/seatsurfing/commit/2046d4a08c6276fca9c543ce68ed0d685736fe79))
* add support for LOGIN auth in smtp client (required i.e. for M365) ([#1337](https://github.com/MoeLa/seatsurfing/issues/1337)) ([e4ce08d](https://github.com/MoeLa/seatsurfing/commit/e4ce08dd3b5afe9f50618d2ea2bd7a13f8a64fd8))
* add translation for confirm delete _your_ booking ([#1700](https://github.com/MoeLa/seatsurfing/issues/1700)) ([7c82eb3](https://github.com/MoeLa/seatsurfing/commit/7c82eb32f97b4d56d1a4853973c856445038027e))
* add username in booking UI navigation ([#1655](https://github.com/MoeLa/seatsurfing/issues/1655)) ([9eed4c4](https://github.com/MoeLa/seatsurfing/commit/9eed4c4a149fc5749ed5c28bbdb3400bc9b58401))
* allow created at timestamp for bookings to be nil ([#1376](https://github.com/MoeLa/seatsurfing/issues/1376)) ([90639f4](https://github.com/MoeLa/seatsurfing/commit/90639f4bec8afdc055ea38e94e361004bf8f3a4c))
* allow images via https in booking ui in order to show custom logos ([#1132](https://github.com/MoeLa/seatsurfing/issues/1132)) ([fb8ce27](https://github.com/MoeLa/seatsurfing/commit/fb8ce27c2b91dc75fce9bb3679184375de0e4f62))
* allow reading certain settings as non-org-admins ([#1405](https://github.com/MoeLa/seatsurfing/issues/1405)) ([acb92d8](https://github.com/MoeLa/seatsurfing/commit/acb92d8b43efc2ad009834c69a21a79b10bf0b76))
* anonymize mail log on org delete ([#1575](https://github.com/MoeLa/seatsurfing/issues/1575)) ([0585f45](https://github.com/MoeLa/seatsurfing/commit/0585f4527d691db346ecd5ff8d01635f9361bea0))
* change default dev port of ui to 3000 ([#1330](https://github.com/MoeLa/seatsurfing/issues/1330)) ([6116bfe](https://github.com/MoeLa/seatsurfing/commit/6116bfef61043358214a8323feb4d070bd985852))
* current day now selectable in search box ([#1692](https://github.com/MoeLa/seatsurfing/issues/1692)) ([73544b0](https://github.com/MoeLa/seatsurfing/commit/73544b00fc28af9cdaa6262bfd9d84a85ceafb1a))
* deleting last booking should delete recurring booking ([#1507](https://github.com/MoeLa/seatsurfing/issues/1507)) ([19a0719](https://github.com/MoeLa/seatsurfing/commit/19a0719564fc6cba36673f78a06e80fcd985b9e6))
* **deps:** bump @playwright/test from 1.54.1 to 1.54.2 in /e2e ([#1144](https://github.com/MoeLa/seatsurfing/issues/1144)) ([9e6e731](https://github.com/MoeLa/seatsurfing/commit/9e6e731bb7bb9e0f41f4b6f141d3425ec60fc144))
* **deps:** bump @playwright/test from 1.54.2 to 1.55.0 in /e2e ([#1204](https://github.com/MoeLa/seatsurfing/issues/1204)) ([0726e2c](https://github.com/MoeLa/seatsurfing/commit/0726e2ccc3a66d7503cb8f28a4be9cdcf8bad9bf))
* **deps:** bump @playwright/test from 1.55.0 to 1.55.1 in /e2e ([#1315](https://github.com/MoeLa/seatsurfing/issues/1315)) ([eca2b7c](https://github.com/MoeLa/seatsurfing/commit/eca2b7c42dff57d45a7ae3cfabff1536d4ffe0ec))
* **deps:** bump @playwright/test from 1.55.1 to 1.56.0 in /e2e ([#1358](https://github.com/MoeLa/seatsurfing/issues/1358)) ([60bed75](https://github.com/MoeLa/seatsurfing/commit/60bed757f670197d76216742d56d90a8d97a08d0))
* **deps:** bump @playwright/test from 1.56.0 to 1.56.1 in /e2e ([#1401](https://github.com/MoeLa/seatsurfing/issues/1401)) ([936ce61](https://github.com/MoeLa/seatsurfing/commit/936ce6106c84f650c633cb67495102c5028fbb93))
* **deps:** bump @playwright/test from 1.56.1 to 1.57.0 in /e2e ([#1494](https://github.com/MoeLa/seatsurfing/issues/1494)) ([18d1063](https://github.com/MoeLa/seatsurfing/commit/18d10630aeaf5dae69ca31a5a3f6038144472c62))
* **deps:** bump @playwright/test from 1.57.0 to 1.58.0 in /e2e ([#1644](https://github.com/MoeLa/seatsurfing/issues/1644)) ([7d9eadc](https://github.com/MoeLa/seatsurfing/commit/7d9eadcc5843ac97513241ef3d2f53444b342cda))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /admin-ui ([#1081](https://github.com/MoeLa/seatsurfing/issues/1081)) ([25cc5d0](https://github.com/MoeLa/seatsurfing/commit/25cc5d04be9d4f3722bfe230a35513db0e7a4f41))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /booking-ui ([#1082](https://github.com/MoeLa/seatsurfing/issues/1082)) ([b9f3b84](https://github.com/MoeLa/seatsurfing/commit/b9f3b84caf35443a9ce200bf837920e99a0d99f1))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /e2e ([#1085](https://github.com/MoeLa/seatsurfing/issues/1085)) ([9834c76](https://github.com/MoeLa/seatsurfing/commit/9834c769cfbf0999adeef80a5db5f9b0a5c904de))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /admin-ui ([#1097](https://github.com/MoeLa/seatsurfing/issues/1097)) ([4889541](https://github.com/MoeLa/seatsurfing/commit/48895412a9051eaa24d0d2c5d778953c07b0e9da))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /booking-ui ([#1101](https://github.com/MoeLa/seatsurfing/issues/1101)) ([0880e46](https://github.com/MoeLa/seatsurfing/commit/0880e46cea90e6a5fbeb7bc7bca0c4b13ce4c237))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /e2e ([#1102](https://github.com/MoeLa/seatsurfing/issues/1102)) ([49576aa](https://github.com/MoeLa/seatsurfing/commit/49576aa973cf6d6c6b5a5b54e5e797e2dd22012d))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /admin-ui ([#1104](https://github.com/MoeLa/seatsurfing/issues/1104)) ([19522e6](https://github.com/MoeLa/seatsurfing/commit/19522e6fae7ef81c3ee2e26e70bb6aec19004f94))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /booking-ui ([#1105](https://github.com/MoeLa/seatsurfing/issues/1105)) ([4c2d847](https://github.com/MoeLa/seatsurfing/commit/4c2d84730489ca38569d72d33a73af08a802edb2))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /e2e ([#1106](https://github.com/MoeLa/seatsurfing/issues/1106)) ([a95d46a](https://github.com/MoeLa/seatsurfing/commit/a95d46ac145fcff4fad8035ba3ec25b334349609))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /admin-ui ([#1150](https://github.com/MoeLa/seatsurfing/issues/1150)) ([3ef1eb6](https://github.com/MoeLa/seatsurfing/commit/3ef1eb6cbb18bf04332c56e9123b91ebdc4fce36))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /booking-ui ([#1149](https://github.com/MoeLa/seatsurfing/issues/1149)) ([aecfc37](https://github.com/MoeLa/seatsurfing/commit/aecfc37e4c7a3759d1720450dbfa81628643f872))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /e2e ([#1151](https://github.com/MoeLa/seatsurfing/issues/1151)) ([c77a581](https://github.com/MoeLa/seatsurfing/commit/c77a58107a10c1e82dc7143a1e8f160a4af64615))
* **deps:** bump @types/node from 24.10.0 to 24.10.1 in /e2e ([#1473](https://github.com/MoeLa/seatsurfing/issues/1473)) ([97cc9d5](https://github.com/MoeLa/seatsurfing/commit/97cc9d51b8e198fca4aeaa5b1de656577732367b))
* **deps:** bump @types/node from 24.10.0 to 24.10.1 in /ui ([#1476](https://github.com/MoeLa/seatsurfing/issues/1476)) ([5ca53de](https://github.com/MoeLa/seatsurfing/commit/5ca53de22a33f3f1b93de493ab581c58053eb588))
* **deps:** bump @types/node from 24.10.1 to 25.0.3 in /e2e ([#1552](https://github.com/MoeLa/seatsurfing/issues/1552)) ([8e63efd](https://github.com/MoeLa/seatsurfing/commit/8e63efd7d313d562b35aee35c5cbb4bd816fa791))
* **deps:** bump @types/node from 24.10.1 to 25.0.3 in /ui ([#1553](https://github.com/MoeLa/seatsurfing/issues/1553)) ([01bf810](https://github.com/MoeLa/seatsurfing/commit/01bf8104ac9cd3b5b3bf6823524f4bb69d088fe9))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /admin-ui ([#1171](https://github.com/MoeLa/seatsurfing/issues/1171)) ([d0f1aec](https://github.com/MoeLa/seatsurfing/commit/d0f1aecf5414d86661b079207464902c766178c8))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /booking-ui ([#1172](https://github.com/MoeLa/seatsurfing/issues/1172)) ([f92eb79](https://github.com/MoeLa/seatsurfing/commit/f92eb79746513bf358ba94f46d14c679b8d113c2))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /e2e ([#1173](https://github.com/MoeLa/seatsurfing/issues/1173)) ([b3f344c](https://github.com/MoeLa/seatsurfing/commit/b3f344cb53030e176e0e345e7914fc69fcca97d1))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /admin-ui ([#1184](https://github.com/MoeLa/seatsurfing/issues/1184)) ([1b100ed](https://github.com/MoeLa/seatsurfing/commit/1b100ed979a1e151620ef4335f32f60f86543ab2))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /booking-ui ([#1185](https://github.com/MoeLa/seatsurfing/issues/1185)) ([719aaab](https://github.com/MoeLa/seatsurfing/commit/719aaabe073e316b5e61ff8e4f519193dd734262))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /e2e ([#1186](https://github.com/MoeLa/seatsurfing/issues/1186)) ([5566e65](https://github.com/MoeLa/seatsurfing/commit/5566e65cebf7ebbc9d35692840138992c0ca2859))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /admin-ui ([#1239](https://github.com/MoeLa/seatsurfing/issues/1239)) ([90b18e2](https://github.com/MoeLa/seatsurfing/commit/90b18e22165033a2b74167ee3e5538cfe38a9c2d))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /booking-ui ([#1240](https://github.com/MoeLa/seatsurfing/issues/1240)) ([15b8140](https://github.com/MoeLa/seatsurfing/commit/15b8140934e17d7f133c0d7775b7bd3d166e2606))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /e2e ([#1241](https://github.com/MoeLa/seatsurfing/issues/1241)) ([b2aac50](https://github.com/MoeLa/seatsurfing/commit/b2aac5000d83a1a1d431007c32ca3749bc9cbb1b))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /admin-ui ([#1303](https://github.com/MoeLa/seatsurfing/issues/1303)) ([57bf92f](https://github.com/MoeLa/seatsurfing/commit/57bf92ff53baf1ec26f58a514e97c595f6942d63))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /booking-ui ([#1304](https://github.com/MoeLa/seatsurfing/issues/1304)) ([4e7d627](https://github.com/MoeLa/seatsurfing/commit/4e7d6273865b2c6247d6502d870ccf4c11739014))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /e2e ([#1305](https://github.com/MoeLa/seatsurfing/issues/1305)) ([f90de15](https://github.com/MoeLa/seatsurfing/commit/f90de158aca023b53d75525e051910c82d6278b9))
* **deps:** bump @types/node from 24.5.2 to 24.6.0 in /e2e ([#1332](https://github.com/MoeLa/seatsurfing/issues/1332)) ([cd84505](https://github.com/MoeLa/seatsurfing/commit/cd845051cf3cbee076d840d07c1bf05888be33fa))
* **deps:** bump @types/node from 24.5.2 to 24.6.0 in /ui ([#1333](https://github.com/MoeLa/seatsurfing/issues/1333)) ([eacd4e7](https://github.com/MoeLa/seatsurfing/commit/eacd4e77aab1c2e12b8fd563947b083634cd52f0))
* **deps:** bump @types/node from 24.6.0 to 24.6.2 in /e2e ([#1346](https://github.com/MoeLa/seatsurfing/issues/1346)) ([84f24a3](https://github.com/MoeLa/seatsurfing/commit/84f24a3f5970936dc067dc68627eb887c347d47f))
* **deps:** bump @types/node from 24.6.0 to 24.6.2 in /ui ([#1347](https://github.com/MoeLa/seatsurfing/issues/1347)) ([f0fcb53](https://github.com/MoeLa/seatsurfing/commit/f0fcb53efea02d99aa80eee3368031b709c70091))
* **deps:** bump @types/node from 24.6.2 to 24.7.1 in /e2e ([#1370](https://github.com/MoeLa/seatsurfing/issues/1370)) ([98487dc](https://github.com/MoeLa/seatsurfing/commit/98487dc953de8a3016035f7e3c572cb49fa7d47f))
* **deps:** bump @types/node from 24.6.2 to 24.7.1 in /ui ([#1371](https://github.com/MoeLa/seatsurfing/issues/1371)) ([0c891bd](https://github.com/MoeLa/seatsurfing/commit/0c891bdf5a34cebedbe5e2f777576d8ca873e284))
* **deps:** bump @types/node from 24.7.1 to 24.8.1 in /e2e ([#1400](https://github.com/MoeLa/seatsurfing/issues/1400)) ([e8e15ec](https://github.com/MoeLa/seatsurfing/commit/e8e15ece9416cb50dcecb0f5087cdc2db64a49a2))
* **deps:** bump @types/node from 24.7.1 to 24.8.1 in /ui ([#1403](https://github.com/MoeLa/seatsurfing/issues/1403)) ([8882311](https://github.com/MoeLa/seatsurfing/commit/88823119cc6e0bcaea30390f3f6434b06f71d9cd))
* **deps:** bump @types/node from 24.8.1 to 24.9.1 in /e2e ([#1421](https://github.com/MoeLa/seatsurfing/issues/1421)) ([f0f066a](https://github.com/MoeLa/seatsurfing/commit/f0f066a700fd838d5f28820add9359a79ca4ce09))
* **deps:** bump @types/node from 24.8.1 to 24.9.1 in /ui ([#1422](https://github.com/MoeLa/seatsurfing/issues/1422)) ([73f1f34](https://github.com/MoeLa/seatsurfing/commit/73f1f34a9ef99aee76388629dcd49d8735f01f1e))
* **deps:** bump @types/node from 24.9.1 to 24.9.2 in /e2e ([#1441](https://github.com/MoeLa/seatsurfing/issues/1441)) ([d663103](https://github.com/MoeLa/seatsurfing/commit/d663103265238f953d1cd5337eb18f30e8cce5ad))
* **deps:** bump @types/node from 24.9.1 to 24.9.2 in /ui ([#1442](https://github.com/MoeLa/seatsurfing/issues/1442)) ([e57c00f](https://github.com/MoeLa/seatsurfing/commit/e57c00f069ade68aea7f3018ccc389b7f0d71c42))
* **deps:** bump @types/node from 24.9.2 to 24.10.0 in /e2e ([#1453](https://github.com/MoeLa/seatsurfing/issues/1453)) ([975ac3a](https://github.com/MoeLa/seatsurfing/commit/975ac3ad8edd7e2cf62e14a905b0b0bcdfbb3d25))
* **deps:** bump @types/node from 24.9.2 to 24.10.0 in /ui ([#1455](https://github.com/MoeLa/seatsurfing/issues/1455)) ([aeacb5b](https://github.com/MoeLa/seatsurfing/commit/aeacb5b05a44892fb16b2e354a0980830c9a82c7))
* **deps:** bump @types/node from 25.0.3 to 25.0.9 in /e2e ([#1616](https://github.com/MoeLa/seatsurfing/issues/1616)) ([8904ce8](https://github.com/MoeLa/seatsurfing/commit/8904ce838e2b8534ca71eb84288a98d794c3465a))
* **deps:** bump @types/node from 25.0.3 to 25.0.9 in /ui ([#1619](https://github.com/MoeLa/seatsurfing/issues/1619)) ([2e2638a](https://github.com/MoeLa/seatsurfing/commit/2e2638a8a801c947e89f71603d3096e060b38e67))
* **deps:** bump @types/node from 25.0.9 to 25.0.10 in /e2e ([#1635](https://github.com/MoeLa/seatsurfing/issues/1635)) ([e730632](https://github.com/MoeLa/seatsurfing/commit/e7306329f5a429b6d8e5d2b7b87c6d946b2ee6df))
* **deps:** bump @types/node from 25.0.9 to 25.0.10 in /ui ([#1636](https://github.com/MoeLa/seatsurfing/issues/1636)) ([e35cd6a](https://github.com/MoeLa/seatsurfing/commit/e35cd6a3a40a63baafd6ef3649c9580505768ff7))
* **deps:** bump @types/react-dom from 19.1.6 to 19.1.7 in /admin-ui ([#1133](https://github.com/MoeLa/seatsurfing/issues/1133)) ([a1e2548](https://github.com/MoeLa/seatsurfing/commit/a1e2548d37f927c414f8f1cd90d88183d911c68a))
* **deps:** bump @types/react-dom from 19.1.6 to 19.1.7 in /booking-ui ([#1134](https://github.com/MoeLa/seatsurfing/issues/1134)) ([9b8a2bd](https://github.com/MoeLa/seatsurfing/commit/9b8a2bd592886052a4f0e73e2322a61a7b9fc4e3))
* **deps:** bump @types/react-dom from 19.1.7 to 19.1.9 in /admin-ui ([#1229](https://github.com/MoeLa/seatsurfing/issues/1229)) ([41406a1](https://github.com/MoeLa/seatsurfing/commit/41406a17ccc4700171bfb5886d3beb5587a42005))
* **deps:** bump @types/react-dom from 19.1.7 to 19.1.9 in /booking-ui ([#1230](https://github.com/MoeLa/seatsurfing/issues/1230)) ([3ea4477](https://github.com/MoeLa/seatsurfing/commit/3ea4477350941176a24785dc56191877491bc5fc))
* **deps:** bump @types/react-dom from 19.2.0 to 19.2.1 in /ui ([#1362](https://github.com/MoeLa/seatsurfing/issues/1362)) ([f914d95](https://github.com/MoeLa/seatsurfing/commit/f914d95f2d0c672adcd954d270686954559d0f44))
* **deps:** bump @types/react-dom from 19.2.1 to 19.2.2 in /ui ([#1386](https://github.com/MoeLa/seatsurfing/issues/1386)) ([46b5d8e](https://github.com/MoeLa/seatsurfing/commit/46b5d8e3bcbf88e0be56bffb7f3099bb7c9bd172))
* **deps:** bump @types/react-dom from 19.2.2 to 19.2.3 in /ui ([#1475](https://github.com/MoeLa/seatsurfing/issues/1475)) ([1a12f93](https://github.com/MoeLa/seatsurfing/commit/1a12f933223ace16e510f710f442d81ac5e26303))
* **deps:** bump bootstrap from 5.3.7 to 5.3.8 in /admin-ui ([#1220](https://github.com/MoeLa/seatsurfing/issues/1220)) ([05c6f86](https://github.com/MoeLa/seatsurfing/commit/05c6f8608133510ff2dfcb121b543578a4d0e405))
* **deps:** bump bootstrap from 5.3.7 to 5.3.8 in /booking-ui ([#1221](https://github.com/MoeLa/seatsurfing/issues/1221)) ([f8c1174](https://github.com/MoeLa/seatsurfing/commit/f8c117457c7bd7d12a8c7a175bf487c9dfc9edbe))
* **deps:** bump eslint from 9.30.1 to 9.31.0 in /admin-ui ([#1078](https://github.com/MoeLa/seatsurfing/issues/1078)) ([130486c](https://github.com/MoeLa/seatsurfing/commit/130486c30729e9f9258632475a820af2ff30f2ab))
* **deps:** bump eslint from 9.30.1 to 9.31.0 in /booking-ui ([#1077](https://github.com/MoeLa/seatsurfing/issues/1077)) ([8b778d7](https://github.com/MoeLa/seatsurfing/commit/8b778d75044a8961d45e14115042998c094b0dfb))
* **deps:** bump eslint from 9.31.0 to 9.32.0 in /admin-ui ([#1118](https://github.com/MoeLa/seatsurfing/issues/1118)) ([c0d9f19](https://github.com/MoeLa/seatsurfing/commit/c0d9f196fbaacc7a5bc57706027ef6170945926c))
* **deps:** bump eslint from 9.31.0 to 9.32.0 in /booking-ui ([#1122](https://github.com/MoeLa/seatsurfing/issues/1122)) ([13f7ab1](https://github.com/MoeLa/seatsurfing/commit/13f7ab11d2543d00b6b605fe5d2a1a7270bfb6b7))
* **deps:** bump eslint from 9.32.0 to 9.33.0 in /admin-ui ([#1179](https://github.com/MoeLa/seatsurfing/issues/1179)) ([f3037c6](https://github.com/MoeLa/seatsurfing/commit/f3037c68b2982fb84b5665241897a808bb251896))
* **deps:** bump eslint from 9.32.0 to 9.33.0 in /booking-ui ([#1180](https://github.com/MoeLa/seatsurfing/issues/1180)) ([880f543](https://github.com/MoeLa/seatsurfing/commit/880f543246c1a1f8662e16f01b4584a5e5477cb3))
* **deps:** bump eslint from 9.33.0 to 9.34.0 in /admin-ui ([#1216](https://github.com/MoeLa/seatsurfing/issues/1216)) ([259be02](https://github.com/MoeLa/seatsurfing/commit/259be02070d288afc4af55faa80650167d96c1af))
* **deps:** bump eslint from 9.33.0 to 9.34.0 in /booking-ui ([#1215](https://github.com/MoeLa/seatsurfing/issues/1215)) ([41a1918](https://github.com/MoeLa/seatsurfing/commit/41a1918db963c9570caefac57098d0eb18f8426b))
* **deps:** bump eslint from 9.34.0 to 9.35.0 in /admin-ui ([#1247](https://github.com/MoeLa/seatsurfing/issues/1247)) ([67f7e29](https://github.com/MoeLa/seatsurfing/commit/67f7e29ebf6cc74f39b4618e9537eacfbeff6696))
* **deps:** bump eslint from 9.34.0 to 9.35.0 in /booking-ui ([#1248](https://github.com/MoeLa/seatsurfing/issues/1248)) ([6203036](https://github.com/MoeLa/seatsurfing/commit/62030367469ec9318121a90ff591fd4f5734a04a))
* **deps:** bump eslint from 9.35.0 to 9.36.0 in /admin-ui ([#1306](https://github.com/MoeLa/seatsurfing/issues/1306)) ([5f9aec7](https://github.com/MoeLa/seatsurfing/commit/5f9aec7b5adccef63d08a1ab7498bb66e8deaa67))
* **deps:** bump eslint from 9.35.0 to 9.36.0 in /booking-ui ([#1307](https://github.com/MoeLa/seatsurfing/issues/1307)) ([2e0e6d1](https://github.com/MoeLa/seatsurfing/commit/2e0e6d1edc5e78289c7ba84929d080505e0401e2))
* **deps:** bump eslint from 9.36.0 to 9.37.0 in /ui ([#1360](https://github.com/MoeLa/seatsurfing/issues/1360)) ([7481708](https://github.com/MoeLa/seatsurfing/commit/74817080152477f96b2c3f4cac29ca5af5664f89))
* **deps:** bump eslint from 9.37.0 to 9.38.0 in /ui ([#1415](https://github.com/MoeLa/seatsurfing/issues/1415)) ([dee504f](https://github.com/MoeLa/seatsurfing/commit/dee504fffe778d60ac4b60890f2047a213957e95))
* **deps:** bump eslint from 9.38.0 to 9.39.1 in /ui ([#1456](https://github.com/MoeLa/seatsurfing/issues/1456)) ([bb25b73](https://github.com/MoeLa/seatsurfing/commit/bb25b73dd04f3be1e916db5f1653bec15c831f59))
* **deps:** bump eslint from 9.39.1 to 9.39.2 in /ui ([#1549](https://github.com/MoeLa/seatsurfing/issues/1549)) ([c346041](https://github.com/MoeLa/seatsurfing/commit/c346041bfa31e7041fba034df3b0912baca60cc5))
* **deps:** bump eslint-config-next from 15.3.5 to 15.4.1 in /admin-ui ([#1079](https://github.com/MoeLa/seatsurfing/issues/1079)) ([0806ef9](https://github.com/MoeLa/seatsurfing/commit/0806ef9f8f28cf8cc7d81058ed568dbd5e450afe))
* **deps:** bump eslint-config-next from 15.3.5 to 15.4.1 in /booking-ui ([#1083](https://github.com/MoeLa/seatsurfing/issues/1083)) ([21f581e](https://github.com/MoeLa/seatsurfing/commit/21f581ebb7d9f02fc1cfa15f8d467ce713cbd715))
* **deps:** bump eslint-config-next from 15.4.1 to 15.4.2 in /admin-ui ([#1098](https://github.com/MoeLa/seatsurfing/issues/1098)) ([652ffc5](https://github.com/MoeLa/seatsurfing/commit/652ffc5b8d891338c3bcbfdd923ed4f682387098))
* **deps:** bump eslint-config-next from 15.4.1 to 15.4.2 in /booking-ui ([#1100](https://github.com/MoeLa/seatsurfing/issues/1100)) ([27f1959](https://github.com/MoeLa/seatsurfing/commit/27f195952cffb2980b13d045b6d5d9cd8742e6e8))
* **deps:** bump eslint-config-next from 15.4.2 to 15.4.3 in /admin-ui ([#1107](https://github.com/MoeLa/seatsurfing/issues/1107)) ([311cc13](https://github.com/MoeLa/seatsurfing/commit/311cc1352c09d0587392479fdf0911de2d852556))
* **deps:** bump eslint-config-next from 15.4.2 to 15.4.3 in /booking-ui ([#1109](https://github.com/MoeLa/seatsurfing/issues/1109)) ([899895b](https://github.com/MoeLa/seatsurfing/commit/899895b8cbefc39d93a381264d4a92a34718933d))
* **deps:** bump eslint-config-next from 15.4.3 to 15.4.4 in /admin-ui ([#1117](https://github.com/MoeLa/seatsurfing/issues/1117)) ([3acd7ce](https://github.com/MoeLa/seatsurfing/commit/3acd7ce37e8c03554a23917e5ae5e79d7d48b21e))
* **deps:** bump eslint-config-next from 15.4.3 to 15.4.4 in /booking-ui ([#1121](https://github.com/MoeLa/seatsurfing/issues/1121)) ([c8d1f28](https://github.com/MoeLa/seatsurfing/commit/c8d1f284cb2288dac11ec36646131cf2d1ed25e9))
* **deps:** bump eslint-config-next from 15.4.4 to 15.4.5 in /admin-ui ([#1136](https://github.com/MoeLa/seatsurfing/issues/1136)) ([c8fe53b](https://github.com/MoeLa/seatsurfing/commit/c8fe53b4ad9107e1f24335f5158806ee3f36cf2d))
* **deps:** bump eslint-config-next from 15.4.4 to 15.4.5 in /booking-ui ([#1138](https://github.com/MoeLa/seatsurfing/issues/1138)) ([ec316bc](https://github.com/MoeLa/seatsurfing/commit/ec316bc24762cd927dd86647a0d833d990a799bb))
* **deps:** bump eslint-config-next from 15.4.5 to 15.4.6 in /admin-ui ([#1162](https://github.com/MoeLa/seatsurfing/issues/1162)) ([5e4f4f7](https://github.com/MoeLa/seatsurfing/commit/5e4f4f74ec1739107d67a5eed0f661fe8aae1d4c))
* **deps:** bump eslint-config-next from 15.4.5 to 15.4.6 in /booking-ui ([#1164](https://github.com/MoeLa/seatsurfing/issues/1164)) ([3d32866](https://github.com/MoeLa/seatsurfing/commit/3d32866eb484bef5265b77fe1f513a549aad71f9))
* **deps:** bump eslint-config-next from 15.4.6 to 15.5.0 in /admin-ui ([#1201](https://github.com/MoeLa/seatsurfing/issues/1201)) ([9e07feb](https://github.com/MoeLa/seatsurfing/commit/9e07febff08ad6cf0c746f93939c5f02982295e2))
* **deps:** bump eslint-config-next from 15.4.6 to 15.5.0 in /booking-ui ([#1203](https://github.com/MoeLa/seatsurfing/issues/1203)) ([c317bc8](https://github.com/MoeLa/seatsurfing/commit/c317bc8ad24f7e0ffacaa4bdfee9c91d07e53582))
* **deps:** bump eslint-config-next from 15.5.0 to 15.5.2 in /admin-ui ([#1227](https://github.com/MoeLa/seatsurfing/issues/1227)) ([6ad0947](https://github.com/MoeLa/seatsurfing/commit/6ad0947bb14b3169077403a2220ac43757700814))
* **deps:** bump eslint-config-next from 15.5.0 to 15.5.2 in /booking-ui ([#1228](https://github.com/MoeLa/seatsurfing/issues/1228)) ([a0a7779](https://github.com/MoeLa/seatsurfing/commit/a0a7779099069267c29d4acf9d0e3e24bf476365))
* **deps:** bump eslint-config-next from 15.5.2 to 15.5.3 in /admin-ui ([#1274](https://github.com/MoeLa/seatsurfing/issues/1274)) ([846e32f](https://github.com/MoeLa/seatsurfing/commit/846e32f6fc80f1a6a191e076aa843e3800d98162))
* **deps:** bump eslint-config-next from 15.5.2 to 15.5.3 in /booking-ui ([#1276](https://github.com/MoeLa/seatsurfing/issues/1276)) ([28530cc](https://github.com/MoeLa/seatsurfing/commit/28530cca5bb0ed8375631297e5e3a0c2143988da))
* **deps:** bump eslint-config-next from 15.5.3 to 15.5.4 in /admin-ui ([#1312](https://github.com/MoeLa/seatsurfing/issues/1312)) ([d2e0837](https://github.com/MoeLa/seatsurfing/commit/d2e0837dcfb0be5929eb6f256ca852a2b24acb85))
* **deps:** bump eslint-config-next from 15.5.3 to 15.5.4 in /booking-ui ([#1314](https://github.com/MoeLa/seatsurfing/issues/1314)) ([b848802](https://github.com/MoeLa/seatsurfing/commit/b848802bc83a8f5c5d43074864441d52495044bf))
* **deps:** bump eslint-config-next from 15.5.4 to 15.5.6 in /ui ([#1404](https://github.com/MoeLa/seatsurfing/issues/1404)) ([b321600](https://github.com/MoeLa/seatsurfing/commit/b321600da1b80de083eb8f3f3432305196a395b3))
* **deps:** bump eslint-config-next from 16.0.1 to 16.0.3 in /ui ([#1479](https://github.com/MoeLa/seatsurfing/issues/1479)) ([4e04865](https://github.com/MoeLa/seatsurfing/commit/4e048656c028cc8e8ea5f466ae0ac90d78cedef9))
* **deps:** bump eslint-config-next from 16.0.10 to 16.1.0 in /ui ([#1556](https://github.com/MoeLa/seatsurfing/issues/1556)) ([7f1245c](https://github.com/MoeLa/seatsurfing/commit/7f1245c4054018237cff87133ee353762732cf11))
* **deps:** bump eslint-config-next from 16.0.3 to 16.0.4 in /ui ([#1487](https://github.com/MoeLa/seatsurfing/issues/1487)) ([6e89d79](https://github.com/MoeLa/seatsurfing/commit/6e89d79b553613f82a053fa37d4f31acbee8b5f8))
* **deps:** bump eslint-config-next from 16.0.4 to 16.0.5 in /ui ([#1497](https://github.com/MoeLa/seatsurfing/issues/1497)) ([59ab2fd](https://github.com/MoeLa/seatsurfing/commit/59ab2fd3030026a63ec7a8e8063a5419adbecf3d))
* **deps:** bump eslint-config-next from 16.0.5 to 16.0.7 in /ui ([#1525](https://github.com/MoeLa/seatsurfing/issues/1525)) ([4729c74](https://github.com/MoeLa/seatsurfing/commit/4729c74182554b8ab95f4a21f6b0e9e857722303))
* **deps:** bump eslint-config-next from 16.0.7 to 16.0.10 in /ui ([#1544](https://github.com/MoeLa/seatsurfing/issues/1544)) ([9067a40](https://github.com/MoeLa/seatsurfing/commit/9067a40c61e3dfa793f19d51c9bd76d5634c2e64))
* **deps:** bump eslint-config-next from 16.1.0 to 16.1.1 in /ui ([#1565](https://github.com/MoeLa/seatsurfing/issues/1565)) ([976020c](https://github.com/MoeLa/seatsurfing/commit/976020ccdd985c6f343db263f690510e9f33bebf))
* **deps:** bump eslint-config-next from 16.1.1 to 16.1.4 in /ui ([#1626](https://github.com/MoeLa/seatsurfing/issues/1626)) ([1df47d6](https://github.com/MoeLa/seatsurfing/commit/1df47d6998751625bc48b2dce368765c0e349f08))
* **deps:** bump eslint-config-next from 16.1.4 to 16.1.5 in /ui ([#1653](https://github.com/MoeLa/seatsurfing/issues/1653)) ([b02f69e](https://github.com/MoeLa/seatsurfing/commit/b02f69e8f44d4eb0ae9838ecc9e56ccaa586bccf))
* **deps:** bump eslint-config-next from 16.1.5 to 16.1.6 in /ui ([#1657](https://github.com/MoeLa/seatsurfing/issues/1657)) ([f85d1fc](https://github.com/MoeLa/seatsurfing/commit/f85d1fcbbf0657054384c344f31266108ebafb6d))
* **deps:** bump excellentexport from 3.9.10 to 3.9.11 in /ui ([#1584](https://github.com/MoeLa/seatsurfing/issues/1584)) ([436f236](https://github.com/MoeLa/seatsurfing/commit/436f236cc19fc51acc772ed25482834830e88d33))
* **deps:** bump github.com/emersion/go-webdav from 0.6.0 to 0.7.0 in /server ([#1419](https://github.com/MoeLa/seatsurfing/issues/1419)) ([fe9c282](https://github.com/MoeLa/seatsurfing/commit/fe9c28256c6d776ae61ec18aa08832b17a75cb3a))
* **deps:** bump github.com/golang-jwt/jwt/v5 from 5.2.3 to 5.3.0 in /server ([#1139](https://github.com/MoeLa/seatsurfing/issues/1139)) ([d0a798d](https://github.com/MoeLa/seatsurfing/commit/d0a798d57c20b617a7333584bef89ec895a87dd0))
* **deps:** bump github.com/golang-jwt/jwt/v5 from 5.3.0 to 5.3.1 in /server ([#1667](https://github.com/MoeLa/seatsurfing/issues/1667)) ([42f1d08](https://github.com/MoeLa/seatsurfing/commit/42f1d0884891c902cb3feca5aed7da947fa2a1ae))
* **deps:** bump github.com/lib/pq from 1.10.9 to 1.11.1 in /server ([#1666](https://github.com/MoeLa/seatsurfing/issues/1666)) ([78885b9](https://github.com/MoeLa/seatsurfing/commit/78885b9db433f1a051562aa955d25d4ee0d7e3db))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.63 to 1.0.64 in /server ([#1166](https://github.com/MoeLa/seatsurfing/issues/1166)) ([10b7e13](https://github.com/MoeLa/seatsurfing/commit/10b7e13c9d98f61d1ae0afb4989107cdde9531e4))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.64 to 1.0.65 in /server ([#1308](https://github.com/MoeLa/seatsurfing/issues/1308)) ([4191182](https://github.com/MoeLa/seatsurfing/commit/4191182b7cfd7fe71b6af5b243d695d54d858606))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.65 to 1.0.66 in /server ([#1319](https://github.com/MoeLa/seatsurfing/issues/1319)) ([af7bbb1](https://github.com/MoeLa/seatsurfing/commit/af7bbb14c527cf2e7fa3ae373fc7844e41af9da7))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.66 to 1.0.67 in /server ([#1388](https://github.com/MoeLa/seatsurfing/issues/1388)) ([490a18a](https://github.com/MoeLa/seatsurfing/commit/490a18a9a93f8d3c759a02508845d7af680b1e80))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.67 to 1.0.68 in /server ([#1472](https://github.com/MoeLa/seatsurfing/issues/1472)) ([1eb2a1a](https://github.com/MoeLa/seatsurfing/commit/1eb2a1accd05107f176f265586a82b4b8386fb16))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.68 to 1.0.69 in /server ([#1529](https://github.com/MoeLa/seatsurfing/issues/1529)) ([49ae08c](https://github.com/MoeLa/seatsurfing/commit/49ae08cb9cc682c18af03723c9dcfe0e59c9228d))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.69 to 1.0.70 in /server ([#1590](https://github.com/MoeLa/seatsurfing/issues/1590)) ([5d84e69](https://github.com/MoeLa/seatsurfing/commit/5d84e69255ebcc00037e0017c5411655ae980a8c))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.70 to 1.0.71 in /server ([#1668](https://github.com/MoeLa/seatsurfing/issues/1668)) ([9b97ee1](https://github.com/MoeLa/seatsurfing/commit/9b97ee14ce39d42c40bfa11ff0a3de397457056c))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.71 to 1.0.72 in /server in the minor-and-patch group ([#1723](https://github.com/MoeLa/seatsurfing/issues/1723)) ([a43a66c](https://github.com/MoeLa/seatsurfing/commit/a43a66c4b918200780c4f1c9e2639f24b34bdc58))
* **deps:** bump golang.org/x/crypto from 0.40.0 to 0.41.0 in /server ([#1165](https://github.com/MoeLa/seatsurfing/issues/1165)) ([fb86183](https://github.com/MoeLa/seatsurfing/commit/fb86183ba3132af29da31f37822315d2b5c55e89))
* **deps:** bump golang.org/x/crypto from 0.41.0 to 0.42.0 in /server ([#1252](https://github.com/MoeLa/seatsurfing/issues/1252)) ([fb3dddf](https://github.com/MoeLa/seatsurfing/commit/fb3dddfded7002b974cb89a4cd8ff0c0aa4487f8))
* **deps:** bump golang.org/x/crypto from 0.42.0 to 0.43.0 in /server ([#1368](https://github.com/MoeLa/seatsurfing/issues/1368)) ([0ee7c45](https://github.com/MoeLa/seatsurfing/commit/0ee7c45c9ea41b93a098e2d46da6ec0be82f9146))
* **deps:** bump golang.org/x/crypto from 0.43.0 to 0.44.0 in /server ([#1478](https://github.com/MoeLa/seatsurfing/issues/1478)) ([2947eb5](https://github.com/MoeLa/seatsurfing/commit/2947eb5043cdbf1594db6a2ad813a14580ee39fa))
* **deps:** bump golang.org/x/crypto from 0.44.0 to 0.45.0 in /server ([#1482](https://github.com/MoeLa/seatsurfing/issues/1482)) ([f97bb64](https://github.com/MoeLa/seatsurfing/commit/f97bb64a38a157771e14478194368fe832562592))
* **deps:** bump golang.org/x/crypto from 0.45.0 to 0.46.0 in /server ([#1536](https://github.com/MoeLa/seatsurfing/issues/1536)) ([1097b46](https://github.com/MoeLa/seatsurfing/commit/1097b46cfc081c4b064a68fc836b2aa8e07e981c))
* **deps:** bump golang.org/x/crypto from 0.46.0 to 0.47.0 in /server ([#1610](https://github.com/MoeLa/seatsurfing/issues/1610)) ([e3858dd](https://github.com/MoeLa/seatsurfing/commit/e3858ddbec73d4ba9f1fd7f817255695716641bf))
* **deps:** bump golang.org/x/oauth2 from 0.30.0 to 0.31.0 in /server ([#1253](https://github.com/MoeLa/seatsurfing/issues/1253)) ([33ea6f0](https://github.com/MoeLa/seatsurfing/commit/33ea6f0706e88f1ba1d7406e105ed58ea09ca5f4))
* **deps:** bump golang.org/x/oauth2 from 0.31.0 to 0.32.0 in /server ([#1367](https://github.com/MoeLa/seatsurfing/issues/1367)) ([c5cfa2a](https://github.com/MoeLa/seatsurfing/commit/c5cfa2a179005e5777a5ae98db8bc269fc548ec5))
* **deps:** bump golang.org/x/oauth2 from 0.33.0 to 0.34.0 in /server ([#1530](https://github.com/MoeLa/seatsurfing/issues/1530)) ([719543e](https://github.com/MoeLa/seatsurfing/commit/719543ef4fc85cc765fd73c1829a49de181c2067))
* **deps:** bump golang.org/x/oauth2 from 0.34.0 to 0.35.0 in /server ([#1707](https://github.com/MoeLa/seatsurfing/issues/1707)) ([0453fec](https://github.com/MoeLa/seatsurfing/commit/0453fec85ed2a61d24cafe75d163913e3541aad0))
* **deps:** bump js-yaml from 4.1.0 to 4.1.1 in /ui ([#1481](https://github.com/MoeLa/seatsurfing/issues/1481)) ([dd1f306](https://github.com/MoeLa/seatsurfing/commit/dd1f30610661de7d27d3cd44a17606ec324bb5c8))
* **deps:** bump library/golang from 1.24-bookworm to 1.25-bookworm ([#1182](https://github.com/MoeLa/seatsurfing/issues/1182)) ([5062367](https://github.com/MoeLa/seatsurfing/commit/5062367cb59760ebbb44d748cf0e17f352ed9b60))
* **deps:** bump library/golang from 1.25-bookworm to 1.25.1-bookworm ([#1339](https://github.com/MoeLa/seatsurfing/issues/1339)) ([8fe3385](https://github.com/MoeLa/seatsurfing/commit/8fe3385254823d1581c4828a2e93cdb56743a5f7))
* **deps:** bump library/golang from 1.25.1-bookworm to 1.25.2-bookworm ([#1366](https://github.com/MoeLa/seatsurfing/issues/1366)) ([f8e3885](https://github.com/MoeLa/seatsurfing/commit/f8e38855a31238ebd90ce654ff43b3c8549d1760))
* **deps:** bump library/golang from 1.25.2-bookworm to 1.25.3-bookworm ([#1392](https://github.com/MoeLa/seatsurfing/issues/1392)) ([9bd1288](https://github.com/MoeLa/seatsurfing/commit/9bd1288b716b1c9ed8bef59fd2b510ef6bef65b8))
* **deps:** bump library/golang from 1.25.3-bookworm to 1.25.4-bookworm ([#1463](https://github.com/MoeLa/seatsurfing/issues/1463)) ([2c12dcd](https://github.com/MoeLa/seatsurfing/commit/2c12dcd8fdb063029091e3bca21dc5b7d1c8c1bb))
* **deps:** bump library/golang from 1.25.4-bookworm to 1.25.5-bookworm ([#1517](https://github.com/MoeLa/seatsurfing/issues/1517)) ([a8984b7](https://github.com/MoeLa/seatsurfing/commit/a8984b7b4156d1c91d78a232cfe18911e6f75032))
* **deps:** bump library/golang from 1.25.5-bookworm to 1.25.6-bookworm ([#1625](https://github.com/MoeLa/seatsurfing/issues/1625)) ([283635c](https://github.com/MoeLa/seatsurfing/commit/283635c7ce3750c0a2b92f27a3cdcdaf3da6a05b))
* **deps:** bump library/golang from 1.25.6-bookworm to 1.25.7-bookworm ([#1704](https://github.com/MoeLa/seatsurfing/issues/1704)) ([3c7ca70](https://github.com/MoeLa/seatsurfing/commit/3c7ca7064fd7f17b5efe18ab9d020fb2941b62fe))
* **deps:** bump library/golang from 1.25.7-bookworm to 1.26.0-bookworm ([#1714](https://github.com/MoeLa/seatsurfing/issues/1714)) ([e23bcb3](https://github.com/MoeLa/seatsurfing/commit/e23bcb3af6dfc31ef60970f1698de62f7acba273))
* **deps:** bump lodash from 4.17.21 to 4.17.23 in /ui ([#1632](https://github.com/MoeLa/seatsurfing/issues/1632)) ([7ba0e72](https://github.com/MoeLa/seatsurfing/commit/7ba0e720bd7a97807c2d2c079fd1ec57f01ff096))
* **deps:** bump lodash-es from 4.17.22 to 4.17.23 in /ui ([#1631](https://github.com/MoeLa/seatsurfing/issues/1631)) ([a732e13](https://github.com/MoeLa/seatsurfing/commit/a732e13cefc4d005992dd861b8dcbb2a5ea0d6af))
* **deps:** bump next from 15.4.1 to 15.4.2 in /admin-ui ([#1096](https://github.com/MoeLa/seatsurfing/issues/1096)) ([54a4ba9](https://github.com/MoeLa/seatsurfing/commit/54a4ba95344be76e79c0cdc9ebb5a6b813411f47))
* **deps:** bump next from 15.4.1 to 15.4.2 in /booking-ui ([#1099](https://github.com/MoeLa/seatsurfing/issues/1099)) ([b2ba650](https://github.com/MoeLa/seatsurfing/commit/b2ba65088891d0187aa761948c03e0e4913c5a3f))
* **deps:** bump next from 15.4.2 to 15.4.3 in /admin-ui ([#1108](https://github.com/MoeLa/seatsurfing/issues/1108)) ([27c94a2](https://github.com/MoeLa/seatsurfing/commit/27c94a2d8ca93058d3fcba8ee5f6aa55877fdd20))
* **deps:** bump next from 15.4.2 to 15.4.3 in /booking-ui ([#1110](https://github.com/MoeLa/seatsurfing/issues/1110)) ([ddd22b1](https://github.com/MoeLa/seatsurfing/commit/ddd22b1d773762592409dce208d2a3cb92b25b1b))
* **deps:** bump next from 15.4.3 to 15.4.4 in /admin-ui ([#1119](https://github.com/MoeLa/seatsurfing/issues/1119)) ([4998ba2](https://github.com/MoeLa/seatsurfing/commit/4998ba2453e37b243913362630d6dd639ba3d458))
* **deps:** bump next from 15.4.3 to 15.4.4 in /booking-ui ([#1120](https://github.com/MoeLa/seatsurfing/issues/1120)) ([0929268](https://github.com/MoeLa/seatsurfing/commit/0929268e538935d4f33f2ef5468128bcb3878437))
* **deps:** bump next from 15.4.4 to 15.4.5 in /admin-ui ([#1135](https://github.com/MoeLa/seatsurfing/issues/1135)) ([1da8e63](https://github.com/MoeLa/seatsurfing/commit/1da8e630de03ace6ee2561440585448dac8cded9))
* **deps:** bump next from 15.4.4 to 15.4.5 in /booking-ui ([#1137](https://github.com/MoeLa/seatsurfing/issues/1137)) ([304ee72](https://github.com/MoeLa/seatsurfing/commit/304ee72480f39f490e1c523a1777490dc004c585))
* **deps:** bump next from 15.4.5 to 15.4.6 in /admin-ui ([#1161](https://github.com/MoeLa/seatsurfing/issues/1161)) ([7b43a8e](https://github.com/MoeLa/seatsurfing/commit/7b43a8ec596df8c18892bde752c44d109f13d01b))
* **deps:** bump next from 15.4.5 to 15.4.6 in /booking-ui ([#1163](https://github.com/MoeLa/seatsurfing/issues/1163)) ([3923062](https://github.com/MoeLa/seatsurfing/commit/39230624183193837839079a98aeadacaed90f68))
* **deps:** bump next from 15.4.6 to 15.5.0 in /admin-ui ([#1200](https://github.com/MoeLa/seatsurfing/issues/1200)) ([f5dfbd5](https://github.com/MoeLa/seatsurfing/commit/f5dfbd5978ec11c5f20e47dc46c9a8f7fd5d52bf))
* **deps:** bump next from 15.4.6 to 15.5.0 in /booking-ui ([#1202](https://github.com/MoeLa/seatsurfing/issues/1202)) ([9f21fac](https://github.com/MoeLa/seatsurfing/commit/9f21fac9509c88177567cfbd8c6b2f798c5b717a))
* **deps:** bump next from 15.5.0 to 15.5.2 in /admin-ui ([#1226](https://github.com/MoeLa/seatsurfing/issues/1226)) ([f5b7d8d](https://github.com/MoeLa/seatsurfing/commit/f5b7d8de109374341d21f30e6f8706e6238f9dd3))
* **deps:** bump next from 15.5.0 to 15.5.2 in /booking-ui ([#1225](https://github.com/MoeLa/seatsurfing/issues/1225)) ([c4d2938](https://github.com/MoeLa/seatsurfing/commit/c4d2938e4caaacf3265effb9816b84ba72786ec5))
* **deps:** bump next from 15.5.2 to 15.5.3 in /admin-ui ([#1273](https://github.com/MoeLa/seatsurfing/issues/1273)) ([973797b](https://github.com/MoeLa/seatsurfing/commit/973797bac0e1578dc42dd851b9db8c2b0a56a2c2))
* **deps:** bump next from 15.5.2 to 15.5.3 in /booking-ui ([#1275](https://github.com/MoeLa/seatsurfing/issues/1275)) ([185faaf](https://github.com/MoeLa/seatsurfing/commit/185faaf7bbba3dfc29e1cbd7ceace0649397aa84))
* **deps:** bump next from 15.5.3 to 15.5.4 in /admin-ui ([#1311](https://github.com/MoeLa/seatsurfing/issues/1311)) ([239d366](https://github.com/MoeLa/seatsurfing/commit/239d3660cd976887861eed44df08063945f8ba76))
* **deps:** bump next from 15.5.3 to 15.5.4 in /booking-ui ([#1313](https://github.com/MoeLa/seatsurfing/issues/1313)) ([5b03aa9](https://github.com/MoeLa/seatsurfing/commit/5b03aa931935a7d39e4fa43107a108e55ad7baed))
* **deps:** bump next from 15.5.4 to 15.5.6 in /ui ([#1402](https://github.com/MoeLa/seatsurfing/issues/1402)) ([636cac3](https://github.com/MoeLa/seatsurfing/commit/636cac3cea3d9801d965ad5bb942bef8c939cbac))
* **deps:** bump next from 16.0.1 to 16.0.3 in /ui ([#1480](https://github.com/MoeLa/seatsurfing/issues/1480)) ([f62bd5f](https://github.com/MoeLa/seatsurfing/commit/f62bd5f7129145755f7a90378aaccc994df739ef))
* **deps:** bump next from 16.0.10 to 16.1.0 in /ui ([#1555](https://github.com/MoeLa/seatsurfing/issues/1555)) ([7e06508](https://github.com/MoeLa/seatsurfing/commit/7e065080e15ec75219ee8c86c335fceb2142381d))
* **deps:** bump next from 16.0.3 to 16.0.4 in /ui ([#1488](https://github.com/MoeLa/seatsurfing/issues/1488)) ([d8c3e0d](https://github.com/MoeLa/seatsurfing/commit/d8c3e0dbeb3d35dff382ddba4095710b564cc896))
* **deps:** bump next from 16.0.4 to 16.0.5 in /ui ([#1499](https://github.com/MoeLa/seatsurfing/issues/1499)) ([f54c592](https://github.com/MoeLa/seatsurfing/commit/f54c592477c90046e623fb41868af32939f6e6cd))
* **deps:** bump next from 16.0.5 to 16.0.7 in /ui ([#1524](https://github.com/MoeLa/seatsurfing/issues/1524)) ([5fb93ce](https://github.com/MoeLa/seatsurfing/commit/5fb93ce02ca2f4c24650de4d510a1cefe5cd0a6e))
* **deps:** bump next from 16.0.7 to 16.0.10 in /ui ([#1541](https://github.com/MoeLa/seatsurfing/issues/1541)) ([3640bd5](https://github.com/MoeLa/seatsurfing/commit/3640bd5866c1382e2e069741a9628263cedaae7e))
* **deps:** bump next from 16.0.7 to 16.0.8 in /ui ([#1535](https://github.com/MoeLa/seatsurfing/issues/1535)) ([4769a92](https://github.com/MoeLa/seatsurfing/commit/4769a92b81e987763448fbbd777a09c264d34dba))
* **deps:** bump next from 16.1.0 to 16.1.1 in /ui ([#1564](https://github.com/MoeLa/seatsurfing/issues/1564)) ([4eb0bfb](https://github.com/MoeLa/seatsurfing/commit/4eb0bfbd06cc10e1b1dfa2558c993affbf57e1bb))
* **deps:** bump next from 16.1.4 to 16.1.5 in /ui ([#1652](https://github.com/MoeLa/seatsurfing/issues/1652)) ([b7b2cb6](https://github.com/MoeLa/seatsurfing/commit/b7b2cb63b03ef75aa0ad3af1f715979b2f7c11f8))
* **deps:** bump next from 16.1.5 to 16.1.6 in /ui in the production-dependencies group across 1 directory ([#1661](https://github.com/MoeLa/seatsurfing/issues/1661)) ([50cdaab](https://github.com/MoeLa/seatsurfing/commit/50cdaaba4af96342d8a087de984e3290e1ca2a85))
* **deps:** bump next to 16.1.4 and react to 19.2.3 ([#1629](https://github.com/MoeLa/seatsurfing/issues/1629)) ([a081d7b](https://github.com/MoeLa/seatsurfing/commit/a081d7ba28b7abc1b2ebafe6c719530a51a87079))
* **deps:** bump Next.js to v16 ([#1470](https://github.com/MoeLa/seatsurfing/issues/1470)) ([37a271a](https://github.com/MoeLa/seatsurfing/commit/37a271ad54d11e54a25052d49d8fb3dc2382d667))
* **deps:** bump prettier from 3.6.2 to 3.7.1 in /ui ([#1498](https://github.com/MoeLa/seatsurfing/issues/1498)) ([8280efb](https://github.com/MoeLa/seatsurfing/commit/8280efb1389fc2815ae887b868e3732c6e9e0348))
* **deps:** bump prettier from 3.7.1 to 3.7.2 in /ui ([#1506](https://github.com/MoeLa/seatsurfing/issues/1506)) ([f2ec898](https://github.com/MoeLa/seatsurfing/commit/f2ec898af5f89a5ed8bf434bcbaf5ac272ed5475))
* **deps:** bump prettier from 3.7.2 to 3.7.4 in /ui ([#1522](https://github.com/MoeLa/seatsurfing/issues/1522)) ([0bd8264](https://github.com/MoeLa/seatsurfing/commit/0bd82649af65dfbf78cac765ea87f8405c101d3e))
* **deps:** bump prettier from 3.7.4 to 3.8.0 in /ui ([#1617](https://github.com/MoeLa/seatsurfing/issues/1617)) ([e2a76e9](https://github.com/MoeLa/seatsurfing/commit/e2a76e9f521748299b16783c4c7e61ad00189512))
* **deps:** bump prettier from 3.8.0 to 3.8.1 in /ui ([#1630](https://github.com/MoeLa/seatsurfing/issues/1630)) ([05fffdd](https://github.com/MoeLa/seatsurfing/commit/05fffdd5a629372d276662aa2ded245995541f80))
* **deps:** bump react from 19.1.1 to 19.2.0 in /ui ([#1349](https://github.com/MoeLa/seatsurfing/issues/1349)) ([696a1c3](https://github.com/MoeLa/seatsurfing/commit/696a1c3c5239c4ea34f50e9137f649807a886532))
* **deps:** bump react from 19.2.0 to 19.2.1 in /ui ([#1523](https://github.com/MoeLa/seatsurfing/issues/1523)) ([88b4790](https://github.com/MoeLa/seatsurfing/commit/88b4790981fb30fe2d46705793eca6fb4c865d70))
* **deps:** bump react to 19.2.0 ([#1350](https://github.com/MoeLa/seatsurfing/issues/1350)) ([f84445b](https://github.com/MoeLa/seatsurfing/commit/f84445b8f1d47a59d7453567cbf9eb2ab83cbc78))
* **deps:** bump react-date-picker from 11.0.0 to 12.0.1 in /admin-ui ([#1153](https://github.com/MoeLa/seatsurfing/issues/1153)) ([1228816](https://github.com/MoeLa/seatsurfing/commit/12288168078917e8752d4a98b3312b6cc1f9ebe3))
* **deps:** bump react-date-picker from 11.0.0 to 12.0.1 in /booking-ui ([#1154](https://github.com/MoeLa/seatsurfing/issues/1154)) ([201e0bb](https://github.com/MoeLa/seatsurfing/commit/201e0bb142d5c5b80de7b30af9289236f3031d83))
* **deps:** bump react-datetime-picker from 6.0.1 to 7.0.1 in /admin-ui ([#1156](https://github.com/MoeLa/seatsurfing/issues/1156)) ([e8cc0cd](https://github.com/MoeLa/seatsurfing/commit/e8cc0cd5463bf7f531084d79bd73fa981cc01bc5))
* **deps:** bump react-datetime-picker from 6.0.1 to 7.0.1 in /booking-ui ([#1155](https://github.com/MoeLa/seatsurfing/issues/1155)) ([ec19d00](https://github.com/MoeLa/seatsurfing/commit/ec19d00453a1c6edd87c97ce4f208d07507979ef))
* **deps:** bump react-dom and @types/react-dom in /ui ([#1348](https://github.com/MoeLa/seatsurfing/issues/1348)) ([99ae839](https://github.com/MoeLa/seatsurfing/commit/99ae8390433f4fb3b92ef3fa35c181df6ccb6f02))
* **deps:** bump react-dom from 19.1.0 to 19.1.1 in /admin-ui ([#1127](https://github.com/MoeLa/seatsurfing/issues/1127)) ([9fd6e0c](https://github.com/MoeLa/seatsurfing/commit/9fd6e0c1360e4ec9d15aa2d018e4923e7bd031a0))
* **deps:** bump react-dom from 19.1.0 to 19.1.1 in /booking-ui ([#1130](https://github.com/MoeLa/seatsurfing/issues/1130)) ([3fe4af8](https://github.com/MoeLa/seatsurfing/commit/3fe4af8b8c40c82af7c0fe6b8ac6ef90a15219a3))
* **deps:** bump react-dom from 19.2.0 to 19.2.1 in /ui ([#1521](https://github.com/MoeLa/seatsurfing/issues/1521)) ([f63f86a](https://github.com/MoeLa/seatsurfing/commit/f63f86acae8e37f390b1c2377192bb8745f6ab7a))
* **deps:** bump react-dom from 19.2.1 to 19.2.3 in /ui ([#1546](https://github.com/MoeLa/seatsurfing/issues/1546)) ([03696c2](https://github.com/MoeLa/seatsurfing/commit/03696c291b08bed22ddc84954808339da9d25701))
* **deps:** bump react-dom from 19.2.3 to 19.2.4 in /ui ([#1651](https://github.com/MoeLa/seatsurfing/issues/1651)) ([87a6931](https://github.com/MoeLa/seatsurfing/commit/87a6931ac7f73abacdf528b32833377aa55b76ae))
* **deps:** bump react-router-dom from 7.6.3 to 7.7.0 in /admin-ui ([#1089](https://github.com/MoeLa/seatsurfing/issues/1089)) ([7dd15b9](https://github.com/MoeLa/seatsurfing/commit/7dd15b925f900e8be23298f5924f8f7abb69baf1))
* **deps:** bump react-router-dom from 7.7.0 to 7.7.1 in /admin-ui ([#1111](https://github.com/MoeLa/seatsurfing/issues/1111)) ([2d9d0f8](https://github.com/MoeLa/seatsurfing/commit/2d9d0f80cac7a4015451be034a507e22e0162faf))
* **deps:** bump react-router-dom from 7.7.1 to 7.8.0 in /admin-ui ([#1160](https://github.com/MoeLa/seatsurfing/issues/1160)) ([c41155a](https://github.com/MoeLa/seatsurfing/commit/c41155aa9e8dbe4f20644e662248101d139d11ee))
* **deps:** bump react-router-dom from 7.8.0 to 7.8.1 in /admin-ui ([#1191](https://github.com/MoeLa/seatsurfing/issues/1191)) ([0ad8ab2](https://github.com/MoeLa/seatsurfing/commit/0ad8ab205001ce6c4ebf864c57fc513a4ea566b9))
* **deps:** bump react-router-dom from 7.8.1 to 7.8.2 in /admin-ui ([#1206](https://github.com/MoeLa/seatsurfing/issues/1206)) ([c83e9bb](https://github.com/MoeLa/seatsurfing/commit/c83e9bbe7a60043eb0b100fa1b8ce3b4a7ee39e4))
* **deps:** bump react-router-dom from 7.8.2 to 7.9.0 in /admin-ui ([#1283](https://github.com/MoeLa/seatsurfing/issues/1283)) ([254c1b2](https://github.com/MoeLa/seatsurfing/commit/254c1b2f23d60089e27e1283638b14abb6a0d4df))
* **deps:** bump react-router-dom from 7.9.0 to 7.9.1 in /admin-ui ([#1294](https://github.com/MoeLa/seatsurfing/issues/1294)) ([e6aff38](https://github.com/MoeLa/seatsurfing/commit/e6aff384a2fa7d41fc6499d9af7cb4d009bcc905))
* **deps:** bump react-router-dom from 7.9.1 to 7.9.2 in /admin-ui ([#1317](https://github.com/MoeLa/seatsurfing/issues/1317)) ([aac9607](https://github.com/MoeLa/seatsurfing/commit/aac96079179e7149ed06c28c266515db78d1af49))
* **deps:** bump react-tooltip from 5.29.1 to 5.30.0 in /ui ([#1383](https://github.com/MoeLa/seatsurfing/issues/1383)) ([b1ffd27](https://github.com/MoeLa/seatsurfing/commit/b1ffd271741683b60054c196a7a101ffec12a083))
* **deps:** bump server dependencies ([#1093](https://github.com/MoeLa/seatsurfing/issues/1093)) ([fdfe497](https://github.com/MoeLa/seatsurfing/commit/fdfe4973d8d70f7e71e50607d4e93d4060536486))
* **deps:** bump the minor-and-patch group in /server with 3 updates ([#1710](https://github.com/MoeLa/seatsurfing/issues/1710)) ([3406453](https://github.com/MoeLa/seatsurfing/commit/34064534ee3a03f438d20dd6642e552c4b872d39))
* **deps:** bump typescript from 5.8.2 to 5.9.2 in /ui ([#1326](https://github.com/MoeLa/seatsurfing/issues/1326)) ([ebac4fb](https://github.com/MoeLa/seatsurfing/commit/ebac4fb2bf531959ba2094a61b2273252f5df57c))
* **deps:** bump typescript from 5.8.3 to 5.9.2 in /commons/ts ([#1141](https://github.com/MoeLa/seatsurfing/issues/1141)) ([97cfb8d](https://github.com/MoeLa/seatsurfing/commit/97cfb8d1d69ddba9146674a847e0bb05e45fc94f))
* **deps:** bump typescript from 5.9.2 to 5.9.3 in /ui ([#1341](https://github.com/MoeLa/seatsurfing/issues/1341)) ([f671ab7](https://github.com/MoeLa/seatsurfing/commit/f671ab74329a51b2dcae72eb28a458fc2f9941c2))
* **deps:** update Go dependencies ([#1466](https://github.com/MoeLa/seatsurfing/issues/1466)) ([3e4c983](https://github.com/MoeLa/seatsurfing/commit/3e4c983c17c081103aefac5632a699e4acbf414d))
* disable password change when logging in via IdP ([#1212](https://github.com/MoeLa/seatsurfing/issues/1212)) ([61660c9](https://github.com/MoeLa/seatsurfing/commit/61660c9fd1b513fce8f68b20f078c85f5e29a656))
* disable VAT VIES check due to unreliable servers ([#1613](https://github.com/MoeLa/seatsurfing/issues/1613)) ([05d49ef](https://github.com/MoeLa/seatsurfing/commit/05d49efab70a9511b2d38d47b7e9ac3c8e23dadc))
* do not redirect non-admin users to admin pages after login ([#1683](https://github.com/MoeLa/seatsurfing/issues/1683)) ([0b037f5](https://github.com/MoeLa/seatsurfing/commit/0b037f5ed650a0a85ff8cfa378e3eba0827a9a0d))
* do not reset approval state when updating booking ([#1261](https://github.com/MoeLa/seatsurfing/issues/1261)) ([46bb41f](https://github.com/MoeLa/seatsurfing/commit/46bb41fd7c4a5a2c0ac4896bb12527a82fb28c7e))
* do not show "enter in future" error in booking interface for today ([#1568](https://github.com/MoeLa/seatsurfing/issues/1568)) ([a048640](https://github.com/MoeLa/seatsurfing/commit/a048640f4ead4791ea4b71799898255f3d9d77c0))
* do not show custom logo in admin UI ([#1379](https://github.com/MoeLa/seatsurfing/issues/1379)) ([33e5cf3](https://github.com/MoeLa/seatsurfing/commit/33e5cf353b57a1ad80a57ebf945d0f6f3941c050))
* do not update user's firstname and lastname if empty in IDP ([#1461](https://github.com/MoeLa/seatsurfing/issues/1461)) ([8aa7591](https://github.com/MoeLa/seatsurfing/commit/8aa7591492dcd414c1f38f09299e25ea171483be))
* docker healthcheck ([#1236](https://github.com/MoeLa/seatsurfing/issues/1236)) ([6e53149](https://github.com/MoeLa/seatsurfing/commit/6e53149a62658d5d4204a29f6987157a6e91e9c7))
* docker healthcheck ([#1260](https://github.com/MoeLa/seatsurfing/issues/1260)) ([be99c49](https://github.com/MoeLa/seatsurfing/commit/be99c49825f53a99b1ca720ce386a7eab1a65852))
* encode UTF-8 characters in mail subjects ([#1733](https://github.com/MoeLa/seatsurfing/issues/1733)) ([df1e613](https://github.com/MoeLa/seatsurfing/commit/df1e613ff98c632c44920b1e899f4f62f276e9a2))
* ensure space position is int instead of float ([#1113](https://github.com/MoeLa/seatsurfing/issues/1113)) ([3ec437c](https://github.com/MoeLa/seatsurfing/commit/3ec437c0c78c3f9781768c9a7ad1f43987aa8b52))
* escape incoming strings ([#1637](https://github.com/MoeLa/seatsurfing/issues/1637)) ([a22e973](https://github.com/MoeLa/seatsurfing/commit/a22e97380c17b777b65072eb5915a3e5503f6fb6))
* expand navigation on viewport "large" ([#1563](https://github.com/MoeLa/seatsurfing/issues/1563)) ([441ca04](https://github.com/MoeLa/seatsurfing/commit/441ca04503d214dcaf9806c3a9806b09d0c3969e))
* fix calculation for min. booking hours ([#1231](https://github.com/MoeLa/seatsurfing/issues/1231)) ([636b30f](https://github.com/MoeLa/seatsurfing/commit/636b30f3d311ff30ef4481819a7deb3a890cf1a1))
* fix cloud upgrade hint links ([#1398](https://github.com/MoeLa/seatsurfing/issues/1398)) ([c426072](https://github.com/MoeLa/seatsurfing/commit/c4260721eeedcbbfc09363230819a34217b37910))
* fix current time in booking calendar ([#1676](https://github.com/MoeLa/seatsurfing/issues/1676)) ([339d2ed](https://github.com/MoeLa/seatsurfing/commit/339d2ed99c8e10b19d6c1904ca1528f7df7f2916))
* fix element for "cancel all upcoming events" container ([#1561](https://github.com/MoeLa/seatsurfing/issues/1561)) ([97b3d00](https://github.com/MoeLa/seatsurfing/commit/97b3d00b5ba1b306cc79a9202016deb5fe145c63))
* fix header "X-Content-Type-Options" ([#1689](https://github.com/MoeLa/seatsurfing/issues/1689)) ([8fcf784](https://github.com/MoeLa/seatsurfing/commit/8fcf784108bf9222f8a488a7bfe89f982d729915))
* fix multi-day bookings in reporting ([#1495](https://github.com/MoeLa/seatsurfing/issues/1495)) ([f986f4a](https://github.com/MoeLa/seatsurfing/commit/f986f4a867b3cef42d3dd89fbc155f6ce2b81a91))
* fix name column in user admin UI ([#1460](https://github.com/MoeLa/seatsurfing/issues/1460)) ([77c6d8a](https://github.com/MoeLa/seatsurfing/commit/77c6d8aa43adc8573a3f1d1e347b7d5d140b05f1))
* fix non German translation for required booking subject setting ([#1579](https://github.com/MoeLa/seatsurfing/issues/1579)) ([0f2b641](https://github.com/MoeLa/seatsurfing/commit/0f2b64149ed01aabae7cdeca90a3e2ff2f73edc5))
* fix panic if user or org is deleted but bearer token is still valid ([#1588](https://github.com/MoeLa/seatsurfing/issues/1588)) ([70bbbe5](https://github.com/MoeLa/seatsurfing/commit/70bbbe59d15667412e7d23098e0879395dd198f1))
* fix timezone issues in calender view ([#1686](https://github.com/MoeLa/seatsurfing/issues/1686)) ([77510c2](https://github.com/MoeLa/seatsurfing/commit/77510c228f4874aa279dcb2995d3d58b672fde36))
* focus escaping on mail variables ([#1640](https://github.com/MoeLa/seatsurfing/issues/1640)) ([096c89d](https://github.com/MoeLa/seatsurfing/commit/096c89dcd2cf40e8679559ec857cdf6613fdf42d))
* improve access control checks ([#1597](https://github.com/MoeLa/seatsurfing/issues/1597)) ([f5dd021](https://github.com/MoeLa/seatsurfing/commit/f5dd021361db3556d4620e5368f417990e7d2aee))
* improve auth provider login handling ([#1468](https://github.com/MoeLa/seatsurfing/issues/1468)) ([f3ee08f](https://github.com/MoeLa/seatsurfing/commit/f3ee08f85a1f850dc0fdd9523ad47b107d066adf))
* improve country selection, add VAT ID validation and add company name ([#1606](https://github.com/MoeLa/seatsurfing/issues/1606)) ([dcffd5f](https://github.com/MoeLa/seatsurfing/commit/dcffd5f6a85245912868ad2a485d3a9c54b8c390))
* improve file naming of ics downloads ([dd3752d](https://github.com/MoeLa/seatsurfing/commit/dd3752de99c769b83a24d9c1e4198298f19995b3))
* improve GetAllDaysPassedSinceSignup function ([#1187](https://github.com/MoeLa/seatsurfing/issues/1187)) ([98ed8d1](https://github.com/MoeLa/seatsurfing/commit/98ed8d16bcbcbe6da6565ace41cb47d9ef08419d))
* improve JWT handling ([#1595](https://github.com/MoeLa/seatsurfing/issues/1595)) ([b7b04ac](https://github.com/MoeLa/seatsurfing/commit/b7b04aca0e6e04816a08369cd83780984f31ea88))
* improve recipient name in emails ([#1581](https://github.com/MoeLa/seatsurfing/issues/1581)) ([a6495ad](https://github.com/MoeLa/seatsurfing/commit/a6495ad6fff03711a7d0d2eb55b993bb9ac6b3be))
* improve resilience when saving locations/spaces ([#1177](https://github.com/MoeLa/seatsurfing/issues/1177)) ([0f31067](https://github.com/MoeLa/seatsurfing/commit/0f31067d1a8ffc53a4d56fdaf4041cb4ca9a2175))
* improve TOTP options code readability ([#1729](https://github.com/MoeLa/seatsurfing/issues/1729)) ([83d2a57](https://github.com/MoeLa/seatsurfing/commit/83d2a57beeae34efefd5047435f2011d3acd20f5))
* include timezone information in iCal export ([#1338](https://github.com/MoeLa/seatsurfing/issues/1338)) ([df3c1c7](https://github.com/MoeLa/seatsurfing/commit/df3c1c77a469de8d36b470044b5e054dea7c641f))
* incorrect access token expiry ([#1176](https://github.com/MoeLa/seatsurfing/issues/1176)) ([3f0007e](https://github.com/MoeLa/seatsurfing/commit/3f0007ea7404559f12d113ab55e5497fcdccc893))
* incorrect font color of admin search bar ([#1336](https://github.com/MoeLa/seatsurfing/issues/1336)) ([2ef06d4](https://github.com/MoeLa/seatsurfing/commit/2ef06d4a627daea664a7f263b2fcfe9194cf6476))
* incorrect image url ([#1363](https://github.com/MoeLa/seatsurfing/issues/1363)) ([70bb954](https://github.com/MoeLa/seatsurfing/commit/70bb954a3dcbb57a3fe19353886ce56a1ce47e1a))
* incorrect names ([#1334](https://github.com/MoeLa/seatsurfing/issues/1334)) ([1b05f92](https://github.com/MoeLa/seatsurfing/commit/1b05f92d165ac7ebf245c53a0b9ffbd5e654d552))
* keycloak OIDC template defaults ([#1641](https://github.com/MoeLa/seatsurfing/issues/1641)) ([a9738c7](https://github.com/MoeLa/seatsurfing/commit/a9738c7b56e7c5b8c3fc06289e04be6ba4f108de))
* **lang:** add Polish translations ([#1194](https://github.com/MoeLa/seatsurfing/issues/1194)) ([6fbbae6](https://github.com/MoeLa/seatsurfing/commit/6fbbae615eafd64211a5a284b35fe6f9bd95fb65))
* **lang:** add Spanish translation ([#1208](https://github.com/MoeLa/seatsurfing/issues/1208)) ([ea868b5](https://github.com/MoeLa/seatsurfing/commit/ea868b5d26873a251702e9c51be56fede130d789))
* limit max date range to 31 days for presence report ([#1467](https://github.com/MoeLa/seatsurfing/issues/1467)) ([b4665b4](https://github.com/MoeLa/seatsurfing/commit/b4665b42cacc91617260bc144d2ee556bd6df6ed))
* made CORS header configurable ([#1599](https://github.com/MoeLa/seatsurfing/issues/1599)) ([393d557](https://github.com/MoeLa/seatsurfing/commit/393d55761f38f284016f124616a81a415f3dc880))
* mail log callback not invoked when using ACS ([#1577](https://github.com/MoeLa/seatsurfing/issues/1577)) ([0092313](https://github.com/MoeLa/seatsurfing/commit/0092313e5fc32728088f58ae82e172a1cba4880f))
* make booking subject readonly for past bookings ([#1268](https://github.com/MoeLa/seatsurfing/issues/1268)) ([a696e64](https://github.com/MoeLa/seatsurfing/commit/a696e64a4c5bc5ce90b69d49a752b721a4189015))
* make sure random code generator always returns a 6 digit code ([#1145](https://github.com/MoeLa/seatsurfing/issues/1145)) ([794a913](https://github.com/MoeLa/seatsurfing/commit/794a913e246c0b9d1f7314d94bd4b7434aea7b0e))
* missing placeholder in delete booking confirm window ([#1698](https://github.com/MoeLa/seatsurfing/issues/1698)) ([599002d](https://github.com/MoeLa/seatsurfing/commit/599002dfdb32a63830a8040430939af02befbf6b))
* move "booking colors" to separate preference tab ([#1560](https://github.com/MoeLa/seatsurfing/issues/1560)) ([9383a24](https://github.com/MoeLa/seatsurfing/commit/9383a24cc6bbef429e2014a1ebc5375d7144f00b))
* optimize credentials handling in frontend ([#1724](https://github.com/MoeLa/seatsurfing/issues/1724)) ([f8991f1](https://github.com/MoeLa/seatsurfing/commit/f8991f1b6c7d540c1a28bae83c948c8a20ed4394))
* persist current booking filter in URL ([#1591](https://github.com/MoeLa/seatsurfing/issues/1591)) ([1d822b8](https://github.com/MoeLa/seatsurfing/commit/1d822b84c0470adce1b1472929a85f3b5025b197))
* preserve query string for default login redirect ([#1380](https://github.com/MoeLa/seatsurfing/issues/1380)) ([d2c44db](https://github.com/MoeLa/seatsurfing/commit/d2c44db47a96c38d867d8e80b5258f049ccbada6))
* prevent open redirect after login ([#1681](https://github.com/MoeLa/seatsurfing/issues/1681)) ([0b88f2f](https://github.com/MoeLa/seatsurfing/commit/0b88f2f9c78b29febeee09e3c53d83b1df2903d0))
* prevent past bookings from being deleted ([#1409](https://github.com/MoeLa/seatsurfing/issues/1409)) ([7b02583](https://github.com/MoeLa/seatsurfing/commit/7b025836979210f241ec2bdef9f716e07bae5ddb))
* prevent user self-deletion ([#1439](https://github.com/MoeLa/seatsurfing/issues/1439)) ([92b4e3b](https://github.com/MoeLa/seatsurfing/commit/92b4e3b1d8972282b3fbdd7275aa3e59f9239076))
* prevent whitespaces in OAuth provider client id and client secret ([#1251](https://github.com/MoeLa/seatsurfing/issues/1251)) ([cb125e7](https://github.com/MoeLa/seatsurfing/commit/cb125e7f8cf577ec1c56d96f9dd485fc306512f3))
* remove "Backend" string from version info log ([#1423](https://github.com/MoeLa/seatsurfing/issues/1423)) ([60ced79](https://github.com/MoeLa/seatsurfing/commit/60ced7970b5a485ff8a06fe444253c8439dfc6cd))
* remove "TOTP" phrase from enforce MFA option as a passkey is als… ([#1734](https://github.com/MoeLa/seatsurfing/issues/1734)) ([5173c50](https://github.com/MoeLa/seatsurfing/commit/5173c508197015f61afe13e682d737dcd681f49d))
* remove debug logs ([#1433](https://github.com/MoeLa/seatsurfing/issues/1433)) ([e0b55ee](https://github.com/MoeLa/seatsurfing/commit/e0b55eeb132338a8a8006d42a7fbafd640e6ae2e))
* remove obsolete fields ([#1639](https://github.com/MoeLa/seatsurfing/issues/1639)) ([1bd2ea3](https://github.com/MoeLa/seatsurfing/commit/1bd2ea35095dce5ead3e137aa48f09a00c2d0548))
* remove public version info ([#1265](https://github.com/MoeLa/seatsurfing/issues/1265)) ([fbaca67](https://github.com/MoeLa/seatsurfing/commit/fbaca67004da87249191fe776d07c9f03d4c7104))
* remove unused translations ([#1671](https://github.com/MoeLa/seatsurfing/issues/1671)) ([f078dfb](https://github.com/MoeLa/seatsurfing/commit/f078dfbfb2ba80706ccf934d231c908662ad213e))
* remove update check in cloud hosting ([#1648](https://github.com/MoeLa/seatsurfing/issues/1648)) ([9df158e](https://github.com/MoeLa/seatsurfing/commit/9df158ed3ad7197e79fbadf2922c0d1f0a2d2a30))
* reset UI runtime config ([#1407](https://github.com/MoeLa/seatsurfing/issues/1407)) ([2bc8ede](https://github.com/MoeLa/seatsurfing/commit/2bc8ede4dbe66794760fca8f64ff5da4249267be))
* respect location timezone when testing if booking can be canceled ([#1310](https://github.com/MoeLa/seatsurfing/issues/1310)) ([cf32df5](https://github.com/MoeLa/seatsurfing/commit/cf32df51c36c707e2824a899d51e8f46412731cb))
* sample map is created with scale 0.0 instead of 1.0 ([#1645](https://github.com/MoeLa/seatsurfing/issues/1645)) ([7206283](https://github.com/MoeLa/seatsurfing/commit/7206283972ebec062460f0e5d7ae3690657a75cd))
* set contact info for default organization ([#1406](https://github.com/MoeLa/seatsurfing/issues/1406)) ([0f9bb10](https://github.com/MoeLa/seatsurfing/commit/0f9bb10a9826995d6e60f6acce47f23e48a5cb9d))
* set firstname and lastname for init org user ([#1377](https://github.com/MoeLa/seatsurfing/issues/1377)) ([0383ecc](https://github.com/MoeLa/seatsurfing/commit/0383ecc83498303351525e65f8f8aa413b08553b))
* set min-width for admin ui sidebar and fix hiding texts on mobile viewport ([#1322](https://github.com/MoeLa/seatsurfing/issues/1322)) ([fe93ea6](https://github.com/MoeLa/seatsurfing/commit/fe93ea6f448df04378a5f6188b9a60275ff351ac))
* set redir parameter for login page if user is not logged in ([#1391](https://github.com/MoeLa/seatsurfing/issues/1391)) ([2a028a8](https://github.com/MoeLa/seatsurfing/commit/2a028a8d8f25a4b8e8a19fb1747c9e75500213bd))
* show "slot conflict" error message in frontend ([#1528](https://github.com/MoeLa/seatsurfing/issues/1528)) ([947fed7](https://github.com/MoeLa/seatsurfing/commit/947fed76ed22b5e6c1a1bb167bf8178db4e2b4c8))
* show currently active bookings on buddy overview ([#1410](https://github.com/MoeLa/seatsurfing/issues/1410)) ([a44e712](https://github.com/MoeLa/seatsurfing/commit/a44e7120993d64b381f33bd6ba66e66b411e58a8))
* show org language and primary contact infos on admin settings page ([#1586](https://github.com/MoeLa/seatsurfing/issues/1586)) ([14a758d](https://github.com/MoeLa/seatsurfing/commit/14a758da63d20c0e5975dbc7e7321a1aed74a2e7))
* show org's primary domain in OAuth callback URL ([#1266](https://github.com/MoeLa/seatsurfing/issues/1266)) ([b34c1ed](https://github.com/MoeLa/seatsurfing/commit/b34c1ed00cbac5bbb6f6f5d750f7d145f4fe026a))
* stop polling pending approvals after logout ([#1167](https://github.com/MoeLa/seatsurfing/issues/1167)) ([e8eb864](https://github.com/MoeLa/seatsurfing/commit/e8eb86423d0471c29a167f731c59dd52ce68b603))
* styling of admin navbar ([#1331](https://github.com/MoeLa/seatsurfing/issues/1331)) ([cb4a8f4](https://github.com/MoeLa/seatsurfing/commit/cb4a8f40efff68ace73dde5d7a557883957d352a))
* support conditions in email templates ([#1147](https://github.com/MoeLa/seatsurfing/issues/1147)) ([3b550a3](https://github.com/MoeLa/seatsurfing/commit/3b550a3dc77b270374c19c57ea2c0e263063e494))
* support redirect URL if already logged in ([#1390](https://github.com/MoeLa/seatsurfing/issues/1390)) ([64734f2](https://github.com/MoeLa/seatsurfing/commit/64734f26aa66cd6a729bb58c33c745fa9e7889f1))
* **tests:** add missing test for org delete ([#1374](https://github.com/MoeLa/seatsurfing/issues/1374)) ([f5d75d6](https://github.com/MoeLa/seatsurfing/commit/f5d75d6241087b4264ecde7b447d615326eec9e9))
* trigger timer on server startup ([#1713](https://github.com/MoeLa/seatsurfing/issues/1713)) ([e656d9c](https://github.com/MoeLa/seatsurfing/commit/e656d9c93087c98334ca453321754d6ef2492a60))
* unify "Du", "Deine" ... in german translation ([#1574](https://github.com/MoeLa/seatsurfing/issues/1574)) ([7eddc7f](https://github.com/MoeLa/seatsurfing/commit/7eddc7f5797190a118e52ef84b0009509459922c))
* unset bool attributed not stored correctly ([#1486](https://github.com/MoeLa/seatsurfing/issues/1486)) ([cc08147](https://github.com/MoeLa/seatsurfing/commit/cc0814743c0c0a860e1f8e72332cd7976d190925))
* update dutch translations ([#1458](https://github.com/MoeLa/seatsurfing/issues/1458)) ([9399b88](https://github.com/MoeLa/seatsurfing/commit/9399b8805ed3f506b586217114df95f4441030f8))
* update german translation for "add" ([#1181](https://github.com/MoeLa/seatsurfing/issues/1181)) ([a57e282](https://github.com/MoeLa/seatsurfing/commit/a57e282b69877cfaa894b8c06226ad96926998d5))
* update mobile-web-app-capable meta tag ([#1647](https://github.com/MoeLa/seatsurfing/issues/1647)) ([ef406d6](https://github.com/MoeLa/seatsurfing/commit/ef406d6b6815f4949f783a804237fb179db56a81))
* update react to 19.2.4 and pin versions of all NPM packages ([#1658](https://github.com/MoeLa/seatsurfing/issues/1658)) ([201e671](https://github.com/MoeLa/seatsurfing/commit/201e67101daeedf2c7ab47643ac888c773e16102))
* update translations for bookings subject setting ([#1572](https://github.com/MoeLa/seatsurfing/issues/1572)) ([1f4d52b](https://github.com/MoeLa/seatsurfing/commit/1f4d52be7d24fd38d3de728c9a88752c14d1068b))
* update user info field names for Microsoft OIDC (fix for [#1501](https://github.com/MoeLa/seatsurfing/issues/1501)) ([#1502](https://github.com/MoeLa/seatsurfing/issues/1502)) ([6a77488](https://github.com/MoeLa/seatsurfing/commit/6a774887d53c01d0737a76fd7e56c6872a7ce30d))
* use expiry from access token ([#1727](https://github.com/MoeLa/seatsurfing/issues/1727)) ([112472c](https://github.com/MoeLa/seatsurfing/commit/112472c1447b3d739ca7ba6fd24a141bc7984083))
* validate and sanitize parameters when sending emails ([#1675](https://github.com/MoeLa/seatsurfing/issues/1675)) ([a1ac095](https://github.com/MoeLa/seatsurfing/commit/a1ac095bd8e48190244ed670f4abc50835e52487))
